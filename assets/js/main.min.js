...
$(".navbar-collapse a").click(function(){$(".navbar-collapse").collapse("hide")}),$(window).scroll(function(){$(".navbar-collapse").collapse("hide")}),new Headroom(document.querySelector("#header"),{tolerance:5,offset:205,classes:{initial:"animation",pinned:"swingInX",unpinned:"swingOutX"}}).init(),$(function(){$("a[href*=\\#]:not([href=\\#])").click(function(){var a=$(this.hash);if(location.hostname==this.hostname&&0!=a.length)return $("html,body").animate({scrollTop:a.offset().top},1e3),!1})}),$(document).ready(function(){var a=$("nav").offset().top,t=$(window).height(),i=$("nav"),o=i.outerHeight(),s=$(document).height();$(window).scroll(function(){var n;$(window).scrollTop()>a?$("#header").addClass("sticky"):$("#header").removeClass("sticky"),n=$(window).scrollTop(),$("section").each(function(){var a=$(this).offset().top-o,e=a+$(this).outerHeight();a<=n&&n<=e?(i.find("a").removeClass("active"),i.find('a[href="#'+$(this).attr("id")+'"]').addClass("active")):n+t==s&&($(".navbar-nav a:last").hasClass("active")||(i.find("a").removeClass("active"),i.find("a:last").addClass("active")))})})});