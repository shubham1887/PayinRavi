<div class="br-header">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <hr>
              <div class="tx-center">
                <span class="profile-earning-label">AEPS Balance</span>
                <h5 class="profile-earning-amount">Rs. <span id="balanceddl3"></span></h5>
                <span class="profile-earning-text"></span>
              </div>
  ...
  {
    $.ajax({type: "GET",url: '<?php echo base_url(); ?>API/Dashboard/getBalance',
      cache: false,
      success: function(html)
      {
        $("#balanceddl").html(html.split("#")[0]);
        $("#balanceddl2").html(html.split("#")[1]);
        $("#balanceddl3").html(html.split("#")[2]);
      }
    }
