<nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <marquee>
                        <p>
                            <span style="color:#ffffff;background-color: #0000ff;padding: 2px 6px;border-radius: 4px;">
                                <strong><?php echo $Message_rslt->row(0)->value; ?></strong>
                            </span>
                    </marquee>
                    <!-- Navbar links -->
                    ...
                    <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body  ml-2  d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold"><?php echo substr($this->session->userdata("SdBusinessName"),0,15); ?></span>
                                    </div>
                                </div>
                            </a>
                            <div class="dropdown-menu  dropdown-menu-right ">
                                ...
                                <a href="<?php echo base_url(); ?>SuperDealer_new/userProfile" class="dropdown-item">
                                    <i class="ni ni-single-02"></i>
                                    <span>My profile</span>
                                </a>
                                <a href="<?php echo base_url(); ?>SuperDealer_new/Change_password" class="dropdown-item">
...
<script language="javascript">
  ...
  function get_balance()
  {
    $.ajax({
        type: "GET",
        url: '<?php echo base_url(); ?>/SuperDealer_new/Dashboard/getBalance',
        cache: false,
    ...
    function getAccessDetails()
    {
        $.ajax({
        type: "GET",
        url: '<?php echo base_url(); ?>/SuperDealer_new/Dashboard/getAccessDetails',
        cache: false,
            success: function(html)
            {
  ...
  function gethourlysale()
    ...
    $.ajax({
          type: "GET",
          url: '<?php echo base_url(); ?>SuperDealer_new/dashboard/getTodaysHourSale',
          cache: false,
          success: function(html)
          {
            var jsonobj = JSON.parse(html);
