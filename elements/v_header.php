                                            ...
                                            <div class="input-group">
                                                <div class="input-group-btn search-panel">
                                                    ...
                                                    <ul class="dropdown-menu scrollable-dropdown" role="menu">
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Automots</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Cell Phs</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Computer Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Health and Personal Care</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Automotive Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Cell Phone Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Computer Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Health and Personal Care</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Automotive Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Cell </a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Computer Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Health and Personal Care</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Automotive Accesories</a></li>
                                                        <li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#" class=" waves-effect waves-block">Cell Phone Accesories</a></li>
                                                        ...
                                                        <button class="header__cart-btn" id="toggle-cart-btn">
                                                            <i class="cart">
                                                                ...
                                                                <div class="custum-dropdown" style="display:none">
                                                                    <ul><li><a href="<?php echo base_url(); ?>Retailer/Recharge_home#">E-Commerce</a></li></ul>
                                                                </div>
                                                            </li>
                                            ...
                                            <div class="asd-nav">
                                                <ul id="leftulbar" class="nav nav-tabs tab-nav-left nav1-tabs1" role="tablist" style="padding-top:5px;border-bottom:none;">
                                                    <li id="dashboard" class="listtryp activee active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."Retailer/Dashboard"; ?>" aria-expanded="false" style=" cursor:pointer;"><i class="fa fa-home" style="color:white;top:-3px;"></i></a>
                                                    </li>
                                                    <li id="recharge" class="listtryp activee active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."Retailer/recharge_home"; ?>" id="recharge" aria-expanded="false">RECHARGE &amp; BILL</a>
                                                    </li>
                                                    <li id="finanical" class="listtryp active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."Retailer/dmrmm_home"; ?>" aria-expanded="true">FINANCIAL</a>
                                                    </li>
                                                    <li id="travel" class="listtryp active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."Retailer/recharge_home"; ?>" aria-expanded="true">TRAVEL</a>
                                                    </li>


                                                    
                                                    <li id="Gift" class="listtryp active" role="presentation" style="padding:0px;">
                                                        <a href="<?php echo base_url()."Retailer/recharge_home"; ?>" aria-expanded="true">GIFT&nbsp;CARDS</a>
                                                    </li>

                                                    <li id="ecommerce" class="listtryp" role="presentation" style="padding:0px; margin-bottom:-27px;">
                                                        <a href="<?php echo base_url()."Retailer/recharge_home"; ?>" aria-expanded="true">E-COMMERCE</a>
                                                    </li>
                ...
                <div class="menus">
                    ...
                    <ul id="leftulbar" class="nav nav-tabs tab-nav-left nav1-tabs1 navi fullbodydycolorbg addnewlogout addnewlogout-responshive" role="tablist" style="padding-top:5px;border-bottom:none;">
                        <li id="dashboard" class="listtryp active" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."Retailer/Dashboard"; ?>" aria-expanded="false"><i><img src="<?php echo base_url();?>vfiles/transport.png"></i>DASHBOARD</a>
                        </li>
                        <li id="recharge" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."Retailer/recharge_home"; ?>" id="recharge" aria-expanded="false"><span class="newimgspan"><i><img src="<?php echo base_url();?>vfiles/validating-ticket.svg" style="text-align: center;margin: 0px auto;position: static;float: none;margin-right: 2px;margin-top: -2px;transform:none;"></i>Prepaid&nbsp;&amp;&nbsp;Utility</span></a>
                        </li>
                        <li id="finanical" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."Retailer/dmrmm_home"; ?>" aria-expanded="true"><span class="newimgspan"><i><img style="transform:none;height: 21px;text-align: center;margin: 0px auto;position: static;float: none;margin-right: 2px;margin-top: -2px;" src="<?php echo base_url();?>vfiles/business.svg"></i>FINANCIAL</span></a>
                        </li>
                        ...
                        <li id="ecommerce" class="listtryp" role="presentation" style="padding:0px;">
                            <a href="<?php echo base_url()."Retailer/recharge_home"; ?>" aria-expanded="true"><span class="newimgspan"><i><img style="transform:none;text-align:center;margin:0px auto;position: static;float: none;margin-right: 2px;margin-top: -3px;height: 15px;" src="<?php echo base_url();?>vfiles/interface(1).png"></i>E-COMMERCE</span></a>
                        </li>
