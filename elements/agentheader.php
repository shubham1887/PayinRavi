<nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    $profile_pic_path = "assets2/img/DPPRG3192.png";
                    $profile_logo_rslt = $this->db->query("select profile_pic_path from tblusers_info where user_id = ?",array($this->session->userdata("AgentId")));
                    if($profile_logo_rslt->num_rows() == 1)
                    {
                        if($profile_logo_rslt->row(0)->profile_pic_path != "")
                        {
                            $profile_pic_path = $profile_logo_rslt->row(0)->profile_pic_path;    
                        }
                   ...
                   <div class="sidenav-toggler  d-xl-block " data-action="sidenav-unpin"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button">
                                Recharge: ₹ <span id="currentMBal">0</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button">
                    ...
                    <ul class="navbar-nav align-items-center  ml-auto ml-md-0 " style="min-width: 200px;">
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" src="<?php echo base_url(); ?>assets2/img/dashboard/logo.png">
                                    </span>
                                    <div class="media-body  ml-2  d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold"><?php echo substr($this->session->userdata("AgentBusinessName"),0,15); ?></span>
                                    </div>
                                </div>
                            </a>
                            <div class="dropdown-menu  dropdown-menu-right ">
                                ...
                                <a href="<?php echo base_url(); ?>Retailer/userProfile" class="dropdown-item">
                                    <i class="ni ni-single-02"></i>
                                    <span>My profile</span>
                                </a>
                                <a href="<?php echo base_url(); ?>Retailer/Change_password" class="dropdown-item">
...
<script language="javascript">
  ...
  function get_balance()
  {
    $.ajax({
      type: "GET",
      url: '<?php echo base_url(); ?>/Retailer/Dashboard/getBalance',
      cache: false,
