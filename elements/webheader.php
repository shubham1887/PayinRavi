<div class="br-header">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <span class="logged-name hidden-md-down"><?php echo substr($this->session->userdata("WebBusinessName"),0,15); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <div class="tx-center">
                ...
                <h6 class="logged-fullname"><?php echo $this->session->userdata("WebBusinessName"); ?></h6>

                <p><?php echo $this->session->userdata("WebEmail"); ?></p>
              ...
              <div class="tx-center" style="display: none;">
...

	{
		...
		$.ajax({type: "GET",url: '<?php echo base_url(); ?>WEB/Dashboard/getBalance',
	...
	function gethourlysale()
		...
		$.ajax({
					...
					url: '<?php echo base_url(); ?>WEB/dashboard/getTodaysHourSale',
