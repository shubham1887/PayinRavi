...
function startexoprt()
{
	...
	$.ajax({
			url:'<?php echo base_url()."Distributor/agent_account_report/dataexport"?>?from='+from+'&to='+to+'&user='+user,
			type:'post',
			cache:false,
...
<div class="DialogMask" style="display:none"></div>
       ...
       <?php include("files/distributorsidebar.php"); ?>
    	...
    	<td align="center" colspan="2">
        	<span id="mobmsg" class="mobmsg"></span>
                           ...
                           <form action="<?php echo base_url()."Distributor/agent_account_report" ?>" method="post" name="frmCallAction" id="frmCallAction">
 ...
 <td style="padding-right:10px;">
     ...
     <?php
	 	$rsl = $this->db->query("select user_id,username,businessname from tblusers where usertype_name = 'Agent' and parentid =? order by businessname",array($this->session->userdata("DistId")));
