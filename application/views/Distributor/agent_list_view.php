...
<?php if($result->status == 0){echo "<span class='red'>Deactive</span>";}else{echo "<span class='green'><a href='#' onclick='actionDeactivate(".$result->user_id.",0)'>Active</a></span>";} ?>
 ...
 <td width="180px">
  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."Distributor/agent_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
 <?php 
