      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."Distributor/dmr_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmReport" id="frmReport">
            ...
            <tr>
            	<td>
                	<h5>From Date :</h5>
                    <input readonly type="text" name="txtFrom" id="txtFrom" value="<?php echo $from; ?>" class="form-control" title="Select From Date." maxlength="10" style="cursor:pointer" />
                </td>
                <td>
                	<h5>To Date :</h5>
                    <input readonly type="text" name="txtTo" id="txtTo" class="form-control" value="<?php echo $to; ?>" title="Select From To." maxlength="10"  style="cursor:pointer" />
                </td>
                <td>
                	<h5>Search :</h5>
       ...
       <form id="frmexport" name="frmexport" action="<?php echo base_url()."Distributor/dmr_report/dataexport" ?>" method="get">
