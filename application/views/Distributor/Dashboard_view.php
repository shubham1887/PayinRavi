   ...
   <!-- ########## START: LEFT PANEL ########## -->
          ...
          <div class="col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-footer tx-12 pd-y-15 bg-transparent">
                <a href="<?php echo base_url()."Retailer/Dmr_report?crypt=".$this->Common_methods->getAgentBalance($this->session->userdata("ApiId")); ?>"><i class="fa fa-angle-down mg-r-5"></i>View All Transaction History</a>
              </div><!-- card-footer -->
            </div><!-- card -->
          </div><!-- col-6 -->
          <!-- col-6 -->
    ...
    <script src="<?php echo base_url(); ?>js/widgets.js"></script>
		...
		function getrechargesummary()
		{
			$.ajax({
					type: "GET",
					url: '<?php echo base_url(); ?>Distributor/Dashboard/getSummary',
					cache: false,
		...
		function getlasttransactions()
		{
			$.ajax({
					type: "GET",
					url: '<?php echo base_url(); ?>Distributor/Dashboard/getLastTransactions',
					cache: false,
					success: function(html)
					{
