          ...
          <div class="col-sm-6 col-lg-12">
           <?php include("elements/messagebox.php");?>
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form method="post" action="<?php echo base_url()."Distributor/agent_registration?crypt=".$this->Common_methods->encrypt("MyData")?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
<table class="table">
<tbody>
<tr>
