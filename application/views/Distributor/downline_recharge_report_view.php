      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."Distributor/downline_recharge_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmsubmit" id="frmsubmit">
...
<form id="frmexport" name="frmexport" action="<?php echo base_url()."Distributor/downline_recharge_report/dataexport" ?>" method="get">
