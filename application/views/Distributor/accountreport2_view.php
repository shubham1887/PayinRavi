      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."Distributor/account_report2" ?>" method="post" name="frmCallAction" id="frmCallAction">
 ...
 <td><?php if($result->credit_amount > 0){echo "-".$result->credit_amount;}else{echo $result->debit_amount;} ?></td>
  ...
  <td><?php echo $result->balance; ?></td>
	...
	function changestatus(val1,id)
	{
				...
				$.ajax({
				url:'<?php echo base_url()."Distributor/account_report2/setvalues?"; ?>Id='+id+'&field=payment_type&val='+val1,
				cache:false,
				method:'POST',
...
<form id="frmexport" name="frmexport" action="<?php echo base_url()."Distributor/account_report2/dataexport" ?>" method="get">
