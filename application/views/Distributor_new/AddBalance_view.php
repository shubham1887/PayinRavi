...
<head>
    ...
    <title><?php echo $this->white->getName() ?>:Providing Financial Services To Every Corner Of India | AddBalance</title>
...
<script src="/js/Old/RG-mem.js"></script>
                ...
                <div class="col-lg-4 col-9">
                    <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="#">Credit</a></li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body pd-xs-10">
                        <div class="row">
                            <div class="col-md-12 pd-0 spbtm">
                                <div class="clearfix"></div>
                                <div class="col-md-12"></div>
                                <div class="clearfix"></div>
<form action="<?php echo base_url(); ?>Distributor_new/AddBalance" method="post"><input name="__RequestVerificationToken" type="hidden" value="9ld-Wv9MJUUPW8CSIivfFYOPVc5TiyvvhHLiNCbJLZOSzNN7bKNEASx--otYqGqdnUtAZtp5bP8yFISo24Yje4pDjGyeKLGOOpNKJNDbpSM1" />                                    <div class="col-xs-12  col-sm-12 col-md-6 col-lg-4">
                                        <label>Select User Type</label>
                                        <div class="form-group">
                                            <select class="form-control" id="User_Type" name="User_Type" required="required"><option value="">Select</option>
<option value="Agent">Retailer</option>
                                    ...
                                    <div class="col-xs-12  col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="Select_UserName" id="Select_UserName"></select>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        <div class="editor-field">
                                            <br />
                                            <label id="currentbal" style="color:cornflowergreen"></label>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                        <label>Amount</label>
                                        <div class="editor-field">
                                            <input autocomplete="off" class="form-control" id="cramount" name="cramount" placeholder="Enter Amount" required="required" type="number" value="" />
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                        <label>Comment</label>
                                        <div class="form-group">
                                            <input autocomplete="off" class="form-control" id="crcomment" name="crcomment" placeholder="Enter Comment" required="required" type="text" value="" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
            ...
            $('#User_Name').change(function () {
                if ($('#User_Name').val() != "") {
                    if (jQuery('#User_Type').val() !== '') {
                        ...
                        $('#Message').html('');
                        $.post('/Distributor_new/AddBalance/FindUserDetailsShort', { requestType: jQuery('#User_Type').val(), requestUser: $('#User_Name').val() }, function (data) {
                            if (data.StatusCode == 1) {
                                var items = "<b>Current Balance : </b>" + data.Data.Balance;
                                $('#currentbal').html(items);
                                jQuery('#Select_UserName').html("<option value='" + data.Data.Username + "'>" + data.Data.UserDetails + "</option>")
                            } else {
                        ...
                        $('#Message').html('Please select usertype.');
                } else
                    $('#Message').html('Please Enter User Name.');
            });

            $('#User_Type').change(function () {
                $.post('/Distributor_new/AddBalance/FindUserDetails', { requestType: $('#User_Type').val() }, function (data) {
                    var items = "<option value=''>Select</option>";
                    $.each(data, function (i, list) {
                        items += "<option value='" + list.Username + "'>" + list.UserDetails + "</option>";
                    });
                    $('#Select_UserName').html(items);
                });
            });
        });
    </script>
