...
<div data-ng-app="myapp">
    <div data-ng-controller="RGPAYCNTRL">
                    ...
                    <div class="row align-items-center py-3">
                        <div class="col-lg-4 col-9">
                            <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Payment Wallet1 Report</a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-lg-8 col-3 text-right">
                            <div class="page-header">
                                    ...
                                    <div class="card-action pull-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item totAmount"><b>Total Amount : {{alltransaction.TotalAmount}}</b></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ml-auto">
                                    <a class="totAmount"><b>Total Amount : {{alltransaction.TotalAmount}}</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-2 col-lg-2 col-sm-2 pd-xs-l-0">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary" data-ng-click="SearchBindData()"><i class="fa fa-search"></i> </button>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-striped table-transaction" id="TableSearch">
                                                ...
                                                <tbody>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters">
                                                        ...
                                                        <td>{{item.Amount}} </td>
                                                        <td>{{item.ClosingBalnce}}</td>
                                                        <td class="tdremark">{{item.remarks}}</td>
                                                        <td><span  class="text text-success">Fund Transfer Successful</span></td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                    <tr data-ng-show="!alltransaction.Data.length">
                                                        <td colspan="8" class="bg-danger p-3 " ><h2 style="color:#fff;"><center>NO DATA AVAILABLE</center></h2></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
...
<script src="<?php echo base_url(); ?>mpayfiles/Dist_angular.js"></script>
<!--Calnedar Plugin-->
