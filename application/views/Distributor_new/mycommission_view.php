...
<body>
 ...
 <?php
    ...
    {
    if($MESSAGEBOXTYPE == "success" or $MESSAGEBOXTYPE == "danger"  or $MESSAGEBOXTYPE == "warning")
    {?>
                    ...
                    <div class="col-lg-4 col-9">
                        <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">My Commission</a></li>
                            </ol>
                        </nav>
                    </div>
    ...
    <div class="container-fluid mt--6">
                        ...
                        <div class="card-body pd-b-0 pd-xs-10">
                            <div class="row">
                                <div class="col-md-12 col-12 col-lg-12 pd-0 searchbox">
                                    <div class="col-md-3 col-12 col-sm-5  pull-right">
                                ...
                                <div class="col-md-12 table-responsive">
                                    <table class="table table-striped table-transaction" id="TableSearch">
                                        ...
                                        <?php
                                        $i=1;
                                        foreach($mycomm->result() as $rwmycom)
                                        {
                                         ...
                                         ?>
                                                        <tr>
                                                            ...
                                                            <td style="width:30%;white-space:initial;">
                                                                <?php echo $rwmycom->company_name; ?>
                                                            </td>

                                                            <td>
                                                                <?php echo $rwmycom->commission_per; ?>
                                                            </td>
                                                            <td>
                                                                <b class="text-orange">&#8377;</b> <?php echo $rwmycom->CommissionAmount; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $rwmycom->Charge_per; ?> <b class="text-red">%</b>
                                                            </td>
                                                            <td>
                                                                <b class="text-orange">&#8377;</b>  <?php echo $rwmycom->Charge_amount; ?>
                                                            </td>
                                                        </tr>
                                        <?php
                                        $i++;
        ...
        <!--Search Table Plugin-->
        <script src="/Content/Js/Search/Search.js"></script>
