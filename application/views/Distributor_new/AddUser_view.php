...
<head>
    ...
    <title><?php echo $this->white->getName() ?>:Providing Financial Services To Every Corner Of India | AddUser</title>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body pd-xs-10">
                        ...
                        <form action="<?php echo base_url(); ?>Distributor_new/AddUser" method="post">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="editor-field">
                                            <select class="form-control" data-val="true" data-val-required="Scheme is required." id="Pattern" name="Pattern" required="">
                                                <option value="">Select</option>
                                                <?php
                                                    $check_CREATE_GROUP_rights = $this->db->query("select user_id from access_rights_alloted where user_id = ? and rights_id = (select Id from access_rights where rights_name = 'CREATE_GROUP')",array($this->session->userdata("DistId")));
                                                    if($check_CREATE_GROUP_rights->num_rows() == 1)
                                                    {
                                                        $rsltgroups = $this->db->query("select Id,group_name from tblgroup where user_id = ?",array($this->session->userdata("DistId")));
                                                    }
                                                    else
                                                    {
                                                        $rsltgroups = $this->db->query("select Id,group_name from tblgroup where user_id = 1 and Id = (select downline_scheme from tblusers where user_id = ?)",array($this->session->userdata("DistId")));
                                                    }
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="editor-field">
                                            ...
                                            <input class="form-control" data-val="true" data-val-maxlength="The field MiddleName must be a string or array type with a maximum length of &#39;30&#39;." data-val-maxlength-max="30" id="MiddleName" name="MiddleName" placeholder="Enter Middle Name" required="" type="text" value="<?php echo $regData["MiddleName"]; ?>" />
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="editor-field">
                                            ...
                                            <input class="form-control" data-val="true" data-val-regex="Invalid pancard format." data-val-regex-pattern="[A-Z]{5}\d{4}[A-Z]{1}" data-val-required="Pancard is required." id="PanCardNo" name="PanCardNo" placeholder="Enter pancard" required="" type="text" value="<?php echo $regData["PanCardNo"]; ?>" />
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        <label>State</label>
                                        <div class="editor-field">
                                            <select class="form-control select-list" data-val="true" data-val-maxlength="The field StateName must be a string or array type with a maximum length of &#39;30&#39;." data-val-maxlength-max="30" data-val-required="State Name is required." id="StateName" name="StateName" required="" onchange="fillcityddl()">
                                                <option value="">Select</option>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="editor-field">
                                            <select class="form-control select-list" data-val="true" data-val-maxlength="The field CityName must be a string or array type with a maximum length of &#39;30&#39;." data-val-maxlength-max="30" data-val-required="City Name is required." id="CityName" name="CityName" required=""><option value="">Select</option>
</select>
