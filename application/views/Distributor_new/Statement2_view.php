                    ...
                    <div class="row align-items-center py-3">
                        <div class="col-lg-4 col-9">
                            <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Statement Report</a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-lg-8 col-3 text-right">
                            <div class="page-header">
                                    ...
                                    <div class="card-action pull-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item success"><b>Total Credit Amount : {{alltransaction.TotalCredit}}</b></a>
                                                <a class="dropdown-item failure"><b> Total Debit Amount : {{alltransaction.TotalDebit}}</b></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ml-auto">
                                    <a class="success"><b> Total Credit : {{alltransaction.TotalCredit}}</b></a>
                                    <a class="failure"><b> Total Debit : {{alltransaction.TotalDebit}}</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <table class="table table-striped table-hover table-transaction" id="fixTable">
                                                ...
                                                <tbody>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters">
                                                        ...
                                                        <td><span data-ng-if="item.Credit!=0.00000">{{item.Credit}}</span>
                                                            <span  data-ng-if="item.Credit==0.00000">-</span>
                                                        </td>
                                                        <td><span data-ng-if="item.Debit!=0.00000">{{item.Debit}}</span>
                                                            <span  data-ng-if="item.Debit==0.00000">-</span>
                                                        </td>
                                                      
                                                        <td>{{item.ClosingBal}}</td>
                                                        <td> <span class="success" data-ng-if="item.Debit!=0.00000"><span class="barSuccess"></span>Debit</span><span class="reversal" data-ng-if="item.Credit!=0.00000"><span class="barReversal"></span>Credit</span></td>
                                                        <td class="tdremark">{{item.NarrationText}}</td>
                                                        <!--<td style="white-space: nowrap;">
                                                            <span class="success" data-ng-if="item.TxnStatus==='Success'"><span class="barSuccess"></span>{{item.TxnStatus}}</span><span class="pending" data-ng-if="item.TxnStatus==='Pending'"><span class="barPending"></span>{{item.TxnStatus}}</span><span class="failure" data-ng-if="item.TxnStatus==='Failure'"><span class="barFailure"></span>{{item.TxnStatus}}</span><span class="reversal" data-ng-if="item.TxnStatus==='Reversal'"><span class="barReversal"></span>{{item.TxnStatus}}</span>
                                                        </td>-->
                                                    </tr>
...
<script src="<?php echo base_url(); ?>mpayfiles/angular.rgstroutewallet2.min.1.7.2.js"></script>
