                                      ...
                                      <div class="col-lg-4 col-9">
                                          <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                                              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                                  ...
                                                  <li class="breadcrumb-item"><a href="#">View All Tickets</a></li>
                                              </ol>
                                          </nav>
                                      </div>
                                  ...
                                  <div class="card">
                                      <div class="card-content">
                                          <div class="card-body pd-b-0 pd-xs-10">
                                              <div class="row">
                                                  <div class="col-md-12">
<form action="<?php echo base_url()."Retailer/ComplainHistory" ?>" method="post">                                                          <div class="row">
                                                              <div class="col-md-5 col-12 col-lg-4 col-sm-5">
                                                              ...
                                                              <div class="col-md-3 col-10 col-lg-3 col-sm-3">
                                                                  <div class="form-group">
                                                                      <input autocomplete="off" class="form-control" id="mobileno" name="mobileno" placeholder="Txn ID" type="text" value="" />
                                                                  </div>
                                                              </div>
                                                              <div class="col-md-1 col-2 col-lg-2 col-sm-1 pull-xs-r pd-xs-l-0">
                                                                  <div class="form-group">
                                                                      <button class="btn btn-primary" type="submit"><i class="fa fa-search"></i> </button>
                                                                  </div>
                                                              </div>
                                                              <div class="col-md-3 col-12 col-lg-3 col-sm-3">
                                                                  <div class="form-group">
                                                          ...
                                                          foreach($result_all->result() as $rw)
                                                            {?>
                                                                          <tr>
                                                                              <td><?php echo $i; ?></td>
                                                                              <td>
                                                                                  <a href="#" title="Ticket ID" class="ItemNo"><?php echo $rw->complain_id; ?></a> <?php echo $rw->complain_type; ?>
                                                                                  <p class="number">
                                                                                      
                                                                                  </p>
                                                                                  
                                                                              </td>
                                                                              <td><p class="datetime"><?php echo $rw->complain_date; ?></p></td>
                                                                              <td>
                                                                                  <?php echo $rw->message; ?>
                                                                              </td>
                                                                              <td class="tdresponse">
                                                                                  <?php echo $rw->response_message; ?>
                                                                              </td>
                                                                              <td>
                                                                              ...
                                                                              <td>
                                                                                <?php if($rw->complain_status == "Solved"){ ?>
                                                                                <span class="success"><span class="barSuccess"></span><?php echo $rw->complain_status; ?></span>
                                                                              <?php } ?>
                                                                              <?php if($rw->complain_status == "Pending"){ ?>
                                                                                <span class="pending"><span class="barPending"></span>Pending</span>
                                                                              <?php } ?>
