...
<div data-ng-app="myapp">
    <div data-ng-controller="DISTDMTMainctrl">
                        ...
                        <div class="col-lg-4 col-9">
                            <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">DMT Report</a></li>
                                </ol>
                            </nav>
                        </div>
                                            ...
                                            <table class="table table-striped table-hover table-transaction" id="fixTable">
                                                ...
                                                <tbody>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters">
                                                        ...
                                                        <td>{{item.RemiterMobile}}</td>
                                                        <td>{{item.Amount}}</td>

                                                        <td style="white-space: nowrap;">
                                                            <span class="success" data-ng-if="item.Status==='SUCCESS'"><span class="barSuccess"></span>{{item.Status}}</span><span class="pending" data-ng-if="item.Status==='PENDING'"><span class="barPending"></span>{{item.Status}}</span><span class="FAILURE" data-ng-if="item.Status==='Failure'"><span class="barFailure"></span>{{item.Status}}</span><span class="reversal" data-ng-if="item.Status==='Reversal'"><span class="barReversal"></span>{{item.Status}}</span>
                                                        </td>

                                                        <td>{{item.RESP_opr_id}} </td>
                                                        <td>{{item.done_by}}</td>
                                                       <td>{{item.add_date}}</td>
