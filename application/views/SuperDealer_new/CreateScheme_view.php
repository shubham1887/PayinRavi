                                         ...
                                         ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>SuperDealer_new/CreateScheme?trackwind=<?php echo $rw->Id; ?>" title="Remove" onclick="return confirm('Are you want Delete Scheme')" style="color:red;">
...
<form action="<?php echo base_url(); ?>SuperDealer_new/CreateScheme" method="post">                            <div class="row">
