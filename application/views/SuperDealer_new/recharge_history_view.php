...
<script>
    function today(a)
    {
        ...
        //call ajax
        $.ajax({
            url: '<?php echo base_url(); ?>SuperDealer_new/Home/Show_Today_All_Recharge',
            type: 'POST',
            dataType: "html",
            data: { yesterday: x },
...
<script>
    $(document).ready(function () {
        ...
        $("#remainretailer").load("<?php echo base_url() ?>SuperDealer_new/recharge_home/getBalance");
    ...
    function disputedata(e) {
        ...
        var txtmob = $('#txtmob').val();
             ...
             $.post("<?php echo base_url(); ?>SuperDealer_new/Recharge_home/dispute",
             {"id": e, "txtregion": ""},
                 function (data) 
                 {
...
<script>
    ...
    $(window).scroll(function () {
            if ($(window).scrollTop() > Number($("#tbldata").height()) / 4 && !NoMoredata && !inProgress) {
                inProgress = true;
                $("#loadingdiv").show();
                $.post("<?php echo base_url(); ?>SuperDealer_new/Home/InfiniteScroll",
...
<script type="text/javascript">
    function GotoPDFRecharge(e) {
                       // alert(e)
                       var idno = e.toString();
                       var url = '<?php echo base_url(); ?>SuperDealer_new/Home/RechargePDF?Idno=' + idno + '';
...
<script>
    function findtotal() {
         ...
         var Operator = $('#Operator').val();
         var txtmob = $('#txtmob').val();
             $.post("<?php echo base_url(); ?>SuperDealer_new/Home/FindTotal",
...
<script type="text/javascript">
    function GenrateInvoice(ultra_request_id, RechargeTo, OptName, amt, OptID, Date) {
       var url = '<?php echo base_url(); ?>SuperDealer_new/Home/GotoInvoicePDF1?Id=' + ultra_request_id + '&RechargeTo=' + RechargeTo + '&OptName=' + OptName + '&amt=' + amt + '&OptID=' + OptID + '&Date=' + Date + '';
            window.open(url, '_blank');
     }
</script>
<script>
   ...
   var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '<?php echo base_url(); ?>SuperDealer_new/Home/ExcelRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        location.href = url;
});
</script>
<script>
    $("#btnPDF").click(function () {
     var txt_frm_date = $('#txt_frm_date').val();
         ...
         var Operator = $('#Operator').val();
        var txtmob = $('#txtmob').val();
        var url = '<?php echo base_url(); ?>SuperDealer_new/Home/PDFRechargereport?txt_frm_date=' + txt_frm_date + '&txt_to_date=' + txt_to_date + '&ddl_status=' + ddl_status + '&Operator=' + Operator + '&txtmob=' + txtmob;
        window.open(
url,
