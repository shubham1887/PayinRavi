...
<form action="<?php echo base_url(); ?>SuperDealer_new/Change_txnpassword" method="post"><input name="__RequestVerificationToken" type="hidden" value="aQG2KCdMKSMrJR1n7RTwr-q-QNU-wWyj0ODTVWEWbz0RVF7nzdtehxoZCptgjY89Q3KxSQrY5T4GauaMSbFn_UyE-dEDdFjPq4Fos1zliL41" />                                    <div class="col-md-4 col-sm-6 col-12">
