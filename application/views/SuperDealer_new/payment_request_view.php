    ...
    <div class="container-fluid">
        <div class="bread-same-all-page allpage-responshivenew">
            <div class="col-md-6">
                <ul>
                    <li class="smli">
                        <a href="<?php echo base_url(); ?>SuperDealer_new/Dashboard" class="fullbodydycolorbg tmw-total-color-one">
            ...
            <div class="col-md-4">
                <div class="fund-trasfer-left fund-user-left">
                    <ul class="nav nav-tabs tabtypeschages tabtypeschages-fullpage" id="tabs">
                        ...
                        <li id="firstontyimetabe" class="tab-link tabChangeType current active" data-tabname="Purchase_ORDER" data-href="/Retailer/payment_request/MDTODealer?tabtype=Purchase_ORDER" data-tab="tab-1" style="width:100% !important;"><a data-toggle="tab" href="<?php echo base_url(); ?>SuperDealer_new/payment_request#menu1" aria-expanded="false">Purchase Rerquest &nbsp;&nbsp; &nbsp;</a></li>
                            ...
                            <div class="fund-transfer-form textarea-classadd" id="frmdata1">
                                ...
                                <div class="w-100 float-left tab-menur tab-menubaar-responsive">
                                    <ul class="w-100 float-left">
                                        <li><a href="<?php echo base_url(); ?>SuperDealer_new/payment_request#" data-oldcr="/Retailer/payment_request/R_Creditchk?MID=Distributor" data-usertype="Distributor" class="chkoldcredit tab-ar  active-ar" data-id="tab1">Request&nbsp;To&nbsp;Distributor</a></li>
                                        <li><a href="<?php echo base_url(); ?>SuperDealer_new/payment_request#" data-oldcr="/Retailer/payment_request/R_Creditchk?MID=Admin" class="chkoldcredit tab-ar" data-usertype="Admin" data-id="tab2">Request&nbsp;To&nbsp;Admin</a></li>
...
<form action="<?php echo base_url(); ?>SuperDealer_new/payment_request" data-ajax="true" data-ajax-failure="OnFailure" data-ajax-mode="replace" data-ajax-success="OnSuccess11" data-ajax-update="#tblshowMasterD" id="form0" method="post">                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div>
