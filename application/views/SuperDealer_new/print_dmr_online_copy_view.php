...
<script language="javascript">
    function myFunction()
    {
        var surchare = prompt("Enter Surcharge");
                            ...
                            <td>
                              <table width="100%" border="1" cellspacing="0" cellpadding="0" style="padding: 5px 2px 3px 2px;">
                                  ...
                                  $total = 0.00;
                        		    ...
                        		    $rsltunique = $this->db->query("SELECT a.unique_id,a.Id,a.add_date,a.user_id,a.DId,a.SdId,a.Charge_type,a.charge_value,a.Charge_Amount,a.RemiterMobile,
                            ...
                            <td>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px 0 3px 0;">
                                <tr>
                                  ...
                                  <td width="" align="left" valign="middle" style="font-family:Arial, sans-serif; font-size:12px; line-height:14px; text-decoration:none; color:#222; font-weight: bold; text-transform: uppercase;"><?php echo $total; ?></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
