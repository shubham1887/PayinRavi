                ...
                <div class="card profilecard">
                    <div class="body profilebodyback profilelastdetail" style="margin-bottom:11px;background-color:whitesmoke;height:3px;">
                            <h1 style="color:#49586e;font-size:20px;font-weight:bold;margin-top:-13px;text-transform:uppercase;">
                                ...
                                RAVIKANT
                                <a style="float:right;cursor:pointer;" id="Editaddresshide"><i class="fa fa-pencil-square-o" id="EditaddressModalssee" style="font-size:22px;margin-top:0px;" onclick="editeaddress('<?php echo $this->Common_methods->encrypt($this->session->userdata("SdId")); ?>')">Edit</i></a>
                            </h1>
