...
<form action="<?php echo base_url(); ?>SuperDealer_new/Change_password" method="post"><input name="__RequestVerificationToken" type="hidden" value="zH6ucKbYCDpo6oL-KLT0zRUiyqULVJhq5fcpqgiZFIp8cWYHQjUokPL8sJ4Cxhw7SSTEiSlPtaLRlWaZ9hjB3lck6uGmlKB60CyCAE6l5qM1" />                                    <div class="col-md-4 col-sm-6 col-12">
