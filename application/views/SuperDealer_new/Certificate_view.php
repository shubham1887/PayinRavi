                                    ...
                                    <div id="dvContents">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-8 mx-auto text-center pd-x-0">
                                            <div class="main1">
                                                ...
                                                <div class="divtext">
                                                    <div class="divtext">
                                                        Certificate No.: RT<?php echo $this->session->userdata("SdId"); ?>
                                                    </div>
                                                </div>
                                                <div class="clogo">
                                                    <img src="<?php echo base_url(); ?>assets2/img/dashboard/logo.png" class="img-fluid" style="margin-top: 0px;z-index:2;" />
                                                </div>
                                                <div class="divtext1">
