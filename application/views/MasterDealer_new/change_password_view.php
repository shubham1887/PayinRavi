...
<form action="<?php echo base_url(); ?>MasterDealer_new/Change_password" method="post"><input name="__RequestVerificationToken" type="hidden" value="zH6ucKbYCDpo6oL-KLT0zRUiyqULVJhq5fcpqgiZFIp8cWYHQjUokPL8sJ4Cxhw7SSTEiSlPtaLRlWaZ9hjB3lck6uGmlKB60CyCAE6l5qM1" />                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Current Password</label>
                                            <div class="editor-field">
                                                <input autocomplete="off" class="form-control" data-val="true" data-val-maxlength="The field CurrentPassword must be a string or array type with a maximum length of &#39;30&#39;." data-val-maxlength-max="30" data-val-required="Current password is required." id="CurrentPassword" maxlength="30" name="CurrentPassword" placeholder="Enter Current Password" required="" style="text-security:disc; -webkit-text-security:disc;" type="text" />
                                                <span class="field-validation-valid error" data-valmsg-for="CurrentPassword" data-valmsg-replace="true"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="editor-field">
                                                <input autocomplete="off" class="form-control" data-val="true" data-val-maxlength="The field NewPassword must be a string or array type with a maximum length of &#39;30&#39;." data-val-maxlength-max="30" data-val-regex="Passwords must be at least 8 characters and contain at 3 of 4 of the following: upper case (A-Z), lower case (a-z), number (0-9) and special character" data-val-regex-pattern="^((?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])|(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[^a-zA-Z0-9])|(?=.*?[A-Z])(?=.*?[0-9])(?=.*?[^a-zA-Z0-9])|(?=.*?[a-z])(?=.*?[0-9])(?=.*?[^a-zA-Z0-9])).{8,}$" data-val-required="New password is required." id="NewPassword" maxlength="30" name="NewPassword" placeholder="Enter New Password" required="" style="text-security:disc; -webkit-text-security:disc;" type="text" />
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="editor-field">
                                                <input autocomplete="off" class="form-control" data-val="true" data-val-equalto="Missmatch password." data-val-equalto-other="*.NewPassword" data-val-maxlength="The field ConfirmPassword must be a string or array type with a maximum length of &#39;30&#39;." data-val-maxlength-max="30" data-val-regex="Passwords must be at least 8 characters and contain at 3 of 4 of the following: upper case (A-Z), lower case (a-z), number (0-9) and special character" data-val-regex-pattern="^((?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])|(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[^a-zA-Z0-9])|(?=.*?[A-Z])(?=.*?[0-9])(?=.*?[^a-zA-Z0-9])|(?=.*?[a-z])(?=.*?[0-9])(?=.*?[^a-zA-Z0-9])).{8,}$" data-val-required="Confirm password is required." id="ConfirmPassword" maxlength="30" name="ConfirmPassword" placeholder="Enter Confirm Password" required="" style="text-security:disc; -webkit-text-security:disc;" type="text" />
