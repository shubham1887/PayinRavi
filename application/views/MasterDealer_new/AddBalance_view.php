                    ...
                    <div class="card-body pd-xs-10">
                        <div class="row">
                            <div class="col-md-12 pd-0 spbtm">
                                ...
                                <div class="clearfix"></div>
<form action="<?php echo base_url(); ?>MasterDealer_new/AddBalance" method="post"><input name="__RequestVerificationToken" type="hidden" value="9ld-Wv9MJUUPW8CSIivfFYOPVc5TiyvvhHLiNCbJLZOSzNN7bKNEASx--otYqGqdnUtAZtp5bP8yFISo24Yje4pDjGyeKLGOOpNKJNDbpSM1" />                                    <div class="col-xs-12  col-sm-12 col-md-6 col-lg-4">
                                        <label>Select Wallet Type</label>
                                        <div class="form-group">
                                            <select class="form-control" id="Wallet_Type" name="Wallet_Type" required="required">
    ...
    <script>
        $(function () {
            $('#User_Name').change(function () {
                if ($('#User_Name').val() != "") 
                {
                    if (jQuery('#User_Type').val() !== '') {
                        ...
                        $('#Message').html('');
                        $.post('/MasterDealer_new/AddBalance/FindUserDetailsShort', { requestType: jQuery('#User_Type').val(), requestUser: $('#User_Name').val() }, function (data) {
            ...
            $('#User_Type').change(function () {
                $.post('/MasterDealer_new/AddBalance/FindUserDetails', { requestType: $('#User_Type').val() }, function (data) {
