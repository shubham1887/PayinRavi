...
<head>
    ...
    <title><?php echo $this->white->getName() ?>:Providing Financial Services To Every Corner Of India | RECHARGE</title>
...
<div data-ng-app="myapp">
    <div data-ng-controller="DISTRECHMainctrl">
                    ...
                    <div class="row align-items-center py-3">
                        <div class="col-lg-4 col-9">
                            <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Recharge Report</a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-lg-8 col-3 text-right">
                            <div class="page-header">
                                    ...
                                    <div class="card-action pull-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item success"><b>Total Success : {{alltransaction.TotalSuccess}}</b></a>
                                                <a class="dropdown-item pending"><b>Total Pending : {{alltransaction.TotalPending}}</b></a>
                                                <a class="dropdown-item failure"><b> Total Failure : {{alltransaction.TotalFailure}}</b></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ml-auto">
                                    <a class="success"><b> Total Success : {{alltransaction.TotalSuccess}}</b></a>
                                    <a class="pending"><b> Total Pending : {{alltransaction.TotalPending}}</b></a>
                                    <a class="failure"><b> Total Failure : {{alltransaction.TotalFailure}}</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body pd-xs-10">
                                <div class="row">
                                    <div class="col-md-4 col-12 col-lg-4 col-xl-4 col-sm-4">
                                    ...
                                    <div class="col-md-3 col-10 col-lg-3 col-sm-3 col-xl-2">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Username" autocomplete="off" data-ng-model="searchusername" />
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-2 col-lg-2 col-sm-1 col-xl-2 pd-xs-r-0">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary" data-ng-click="doforfindingdata()"><i class="fa fa-search"></i> </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover table-transaction" id="fixTable">
                                                <thead>
                                                    <tr>
                                                        <th>Sr.No.</th>
                                                        <th>User Details</th>
                                                        <th>Recharge Detail</th>
                                                        <th>Mobile</th>
                                                        <th>Amount</th>
                                                        <th>Status</th>
                                                        <th>TxnId</th>
                                                ...
                                                <tbody>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters">
                                                        ...
                                                        <td>
                                                            {{item.businessname}} | {{item.usertype_name}}
                                                            <p class="number">
                                                                {{item.username}}
                                                            </p>
                                                        </td>
                                                        <td>
                                                            Recharge | {{item.company_name}}
                                                            <p class="number">
                                                                {{item.recharge_id}}
                                                            </p>
                                                            <p class="datetime">
                                                        ...
                                                        <td style="white-space: nowrap;">
                                                            <span class="success" data-ng-if="item.recharge_status==='Success'"><span class="barSuccess"></span>{{item.recharge_status}}</span><span class="pending" data-ng-if="item.recharge_status==='Pending'"><span class="barPending"></span>{{item.recharge_status}}</span><span class="failure" data-ng-if="item.recharge_status==='Failure'"><span class="barFailure"></span>{{item.recharge_status}}</span><span class="reversal" data-ng-if="item.recharge_status==='Reversal'"><span class="barReversal"></span>{{item.recharge_status}}</span>
                                                        </td>

                                                        <td>{{item.operator_id}} </td>
                                                        <td>{{item.recharge_by}}</td>
...
<script src="<?php echo base_url(); ?>mpayfiles/angular.distroute.min.1.7.2.js"></script>
