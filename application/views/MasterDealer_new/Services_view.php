            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                            ...
                            <div class="col-md-12" style="overflow:auto;">
                                <table class="table tableServices">
                                    ...
                                    <tbody>
                                                    <tr>
                                                        ...
                                                        <td><b>AEPS</b></td>
                                                        <td><span class="charges">&#8377; 500.00</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>DTH</b></td>
                                                        <td><span class="charges">&#8377; 0.00</span></td>
                                                        <td>
                                                                <span style="color:green">Active</span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>IRCTC</b></td>
                                                        <td><span class="charges">&#8377; 3500.00</span></td>
                                                        <td>
                                                                <span style="color:green">Active</span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>Pancard</b></td>
                                                        <td><span class="charges">&#8377; 800.00</span></td>
                                                        <td>
                                                                <span style="color:green">Active</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><span class="charges">&#8377; 1500.00</span></td>
                                                        <td>
                                                                <span style="color:green">Active</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                                <label class="container1">
                                                                    <input type="checkbox" name="Services" title="PG" value="23" onclick="doPreProcessSrv(this,500.00)" />
                                                        ...
                                                        <td><span class="charges">&#8377; 500.00</span></td>
                                                        <td>
                                                                  <span style="color:orange">Buy</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>15</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                                <label class="container1">
                                                                    <input type="checkbox" name="Services" title="PurchaseService" value="24" onclick="doPreProcessSrv(this,0.00)" />
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                        </td>
                                                        <td><b>PurchaseService</b></td>
                                                        <td><span class="charges">&#8377; 0.00</span></td>
                                                        <td>
                                                                  <span style="color:orange">Buy</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>Travels </b></td>
                                                        <td><span class="charges">&#8377; 1000.00</span></td>
                                                        <td>
                                                                <span style="color:green">Active</span>
                                                        </td>
                                                    </tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <b style="color:#aa0000;font-size: 16px;">&#8377; 9300.00 </b>
                                                <input type="hidden" id="hfPurchasePrice" value="0" />
                                            </td>
                                            <td id="showPurchasePrice"></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                                <div class="col-md-12 text-center">
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-primary purchaseServ" />
                                    </div>
                                </div>
                        </div>
                    </div>
                        ...
                        <div id="modalConfrimation" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
                            <div class="modal-dialog fadeInRight animated modal-sm modalLogin">
                                <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="<?php echo base_url(); ?>MasterDealer_new/Services" method="post">
                                            <div class="row">
                                                <input name="__RequestVerificationToken" type="hidden" value="8nDWO5fRNoVrscl9ozUb-HT-LvHgo2EokkP5EvH3rNkqqVe7qbK5p069yA_McOrOwkuRBRFEKVn9OkO9W8GTUacgiZQkLI26h-OFIAZrteE1" />
                                                <div class="col-md-12 text-center">
                                                    <div class="form-group">
                                                        <img src="<?php echo base_url(); ?>mpayfiles/question.png" />
                                                    </div>
                                                </div>
                                                <div class="col-md-12 text-center">
                                                    Are you sure, you want to do activation?
                                                    <input type="hidden" name="ActivationserviceList" id="ActivationserviceList" />
                                                </div>
                                                <div class="col-md-12 text-center sptop">
                                                    <button type="submit" class="btn btn-primary btnlogin" style="width:auto;margin-right:10px;">Confirm</button>
                        ...
                        <script>
                            jQuery(function () {
                                jQuery('.purchaseServ').click(function () {
                                    jQuery('#ActivationserviceList').val('');
                                    var srvs = new Array();
                                    jQuery("input[name='Services']:checked").each(function () {
                                        srvs.push($(this).val());
                                    });
                                    if (srvs.length > 0) {
                                        var currentBal = jQuery('#currentMBal').html();
                                        var srvsPrice = jQuery('#hfPurchasePrice').val();
                                        if (parseFloat(currentBal) >= parseFloat(srvsPrice)) {
                                            jQuery('#modalConfrimation').modal('show');
                                            jQuery('#ActivationserviceList').val(srvs);
                                        } else {
                                            swal('', "You don't have sufficient balance for services activation.", 'error');
                                        }
                                    } else {
                                        swal('', 'Please select activation service.', 'error');
                                    }
                                });
                            });

                            function doPreProcessSrv(ID, price) {
                                if (jQuery(ID).is(":checked")) {
                                    var oldPrice = jQuery('#hfPurchasePrice').val();
                                    var totalAmt = parseFloat(oldPrice) + parseFloat(price);
                                    jQuery('#hfPurchasePrice').val(totalAmt);
                                    jQuery('#showPurchasePrice').html('<b style="font-size: 16px;">Purchase Price : </b><b style="color:#aa0000;font-size: 16px;">&#8377; ' + totalAmt + '</b>');
                                } else {
                                    var oldPrice = jQuery('#hfPurchasePrice').val();
                                    var totalAmt = parseFloat(oldPrice) - parseFloat(price);
                                    jQuery('#hfPurchasePrice').val(totalAmt);
