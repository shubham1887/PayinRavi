    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="<?php echo base_url()."MasterDealer_new/dashboard"; ?>">Dashboard</a>
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."MasterDealer_new/accountreport2" ?>" method="post" name="frmCallAction" id="frmCallAction">
 ...
 <td><?php if($result->credit_amount > 0){echo "-".$result->credit_amount;}else{echo $result->debit_amount;} ?></td>
  ...
  <td><?php echo $result->balance; ?></td>
	...
	function changestatus(val1,id)
	{
				...
				$.ajax({
				url:'<?php echo base_url()."Retailer/account_report2/setvalues?"; ?>Id='+id+'&field=payment_type&val='+val1,
				cache:false,
				method:'POST',
...
<form id="frmexport" name="frmexport" action="<?php echo base_url()."Retailer/account_report2/dataexport" ?>" method="get">
