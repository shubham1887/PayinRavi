...
<?php
    ...
    {
    if($MESSAGEBOXTYPE == "success" or $MESSAGEBOXTYPE == "info"  or $MESSAGEBOXTYPE == "error")
    {?>
                ...
                <div class="col-lg-4 col-9">
                    <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="#">Raise Complains</a></li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body pd-xs-10">
                        <div class="row sptop">
                            <div class="col-md-12 col-12 col-lg-12 pd-0 searchbox">
<form action="<?php echo base_url(); ?>MasterDealer_new/Raisecomplain" method="post">                                    <div class="col-md-6 col-12 col-lg-4 col-sm-5">
                                        <div class="form-group">
                                            <label>Subject:</label>
                                            <select class="form-control" id="ddlsubject" name="ddlsubject" onchange="return getsubchnage();">
...
<option value="Sales Inquiry">Sales Inquiry</option>
                                    ...
                                    <div class="col-md-6 col-12 col-lg-4 col-sm-5">
                                        <div class="form-group">
                                            <div id="tranDiv" style="display: none">
                                                <label>Transaction ID:</label>
                                                <input class="form-control" id="tranid" name="tranid" placeholder="Transaction Id" type="text" value="" />

                                                <label for="" id="lbltarn" style="color:rgb(240, 141, 141)">No</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-md-6 col-12 col-lg-4 col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <label for="" id="lblmsg" style="color:rgb(249, 129, 129);text-transform:inherit;">If you required any information related with technical / sales &amp; Billing, then please mention your issue in the &#39;Message&#39; Field.</label>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-md-6 col-12 col-lg-4 col-sm-5">
    ...
    <script type="text/javascript">
        function getsubchnage() {
            var data = $("#ddlsubject option:selected").text();
            if (data == "Transaction Dispute") {
                $("#tranDiv").show();
                $("#lblmsg").html("");
                $("#lbltarn").html(" Note : To get your Transaction ID please refer to the 'Recharge History' Section If you need to furnish any additional details please mention in the 'Message' Field Recharge dispute should be reported within 24 hours from the transaction time.");
            } else { $("#tranDiv").hide(); $("#lblmsg").html("If you required any information related with technical / sales & Billing, then please mention your issue in the 'Message' Field"); }
        }
    </script>
