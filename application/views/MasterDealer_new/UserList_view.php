            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body pd-xs-10">
                        ...
                        <form action="<?php echo base_url(); ?>MasterDealer_new/UserList" method="post">
                            <input name="__RequestVerificationToken" type="hidden" value="9DuVRusrigh7z8-SsD6RtJEYQsKtjsD1YT5veY8JILrAzqIkau9dpvfHlhVshaqXebmyfC_eaqyZJIa4qqiH8HTDWDygEWjUQyYniURk4PI1">
                            <div class="row">
                                <div class="col-md-3 col-12 col-lg-3 col-sm-5 pd-xs-0">
                                    <div class="form-group">
                                        <select name="searchType" class="form-control" required="">
                                            <option value="">Select</option>
                                                    <option selected="selected" value="Distributor">Distributor</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3 col-10 col-lg-3 col-sm-5 pd-l-0 pd-xs-0">
                                    <div class="form-group">
                                        <input type="text" name="searchNumber" class="form-control" placeholder="Search by mobile No" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-2 col-2 col-lg-2 col-sm-2 pd-xs-r-0">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" data-ng-click="getTransactionreports()"><i class="fa fa-search"></i> </button>
                                    </div>
                                </div>
                                <div class="col-md-2 col-2 col-lg-2 col-sm-2 pull-xs-r pd-xs-r-0">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2 col-10 col-lg-2 col-sm-3 pd-xs-0">
                                    <div class="form-group">
                        ...
                        <div class="col-md-12 pd-0">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="fixTable">
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>UserName</th>
                                            ...
                                            {?>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters">
                                                        ...
                                                        <td style="white-space: nowrap;">
                                                            ...
                                                            <?php if($rw->status == "1") {?>
                                                            <span class="success"><span class="barSuccess"></span>Active</span> 
                                                            <?php } else { ?>
                                                        ...
                                                        <td><a href="EditUser?UserId=<?php echo $this->Common_methods->encrypt($rw->user_id); ?>" title="Update user">Edit</a> </td>
                                                    </tr>
                                            <?php $i++;} ?>
                                    </tbody>
                                </table>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6">
                        <div class="copyright text-center text-lg-left text-muted">
                            Copyright ©2020 - <?php echo $this->white->getName(); ?>
                        </div>
                    </div>
