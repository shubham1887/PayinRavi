                ...
                <div class="col-lg-4 col-9">
                    <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="#">Wallet2 Report</a></li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body pd-b-0 pd-xs-10">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="<?php echo base_url(); ?>MasterDealer_new/Statement2" method="post">
                                        ...
                                        <?php
                                            ...
                                            if($result_date != false)
                                            {
                                                ...
                                                {?>
                                                        ...
                                                        <td><?php
                                                         if ($rw->cr_businessname != null) {
                                                            echo $rw->cr_businessname."|".$rw->cr_mobile_no;
                                                        }elseif ($rw->cr_businessname != null) {
                                                            echo $rw->cr_businessname."|".$rw->cr_mobile_no;
                                                        }elseif ($rw->dr_businessname != null) {
                                                             echo $rw->dr_businessname."|".$rw->dr_businessname;
                                                        }
                                                    ?></td>

                                                        <td><center><?php echo $rw->OpeningBal ?></center></td>
                                                       
                                                        <td><center>
                                                            <?php 

                                                            if ($rw->credit_amount != "0") {
                                                                echo $rw->credit_amount; 
                                                            }else{
                                                                echo"-";
                                                            }
                                                        ...
                                                        <td><center>
                                                            <?php 
                                                            if ($rw->debit_amount != "0") {
                                                                echo $rw->debit_amount; 
                                                            }else{
                                                                echo"-";
                                                            }
                                                        ...
                                                        <td><center><?php echo $rw->balance ?></center></td>
                                                       
                                                        <td>
                                                            <?php echo $rw->remark; ?>
                                                        </td>
                                                        <td>
                                                           <?php if($rw->transaction_type == "CRADIT")
                                                                {?>
                                                                        
                                                                        <span style="color:Blue;">CRADIT</span>
                                                            <?php }?>


                                                            <?php if($rw->transaction_type == "DEBIT")
                                                                {?>

                                                                        <span style="color:red;">DEBIT</span>
                                                            <?php }?>

                                                            <?php if($rw->transaction_type == "PAYMENT" or $rw->transaction_type == "COMMISSION" )
                                                                {?>
