                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                           ...
                           <form method="post" action="<?php echo base_url()."_Admin/fos_edit?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
<input type="hidden" name="hiduserid" value="<?php echo $result_user->row(0)->user_id; ?>">
<table class="table">
<tbody>
<tr>
<td><h5>Fos Name :</h5><input type="text" class="form-control-sm" placeholder="Enter Retailer Name." id="txtDistname" name="txtDistname" value="<?php echo $result_user->row(0)->businessname; ?>"  maxlength="100" style="width:300px;"/>
</td>
<td><h5>Select Parent:</h5>
<select id="ddlparent" name="ddlparent" class="form-control-sm" style="width:300px;">
<option value="1">Select</option>
<?php
	$rlstparent = $this->db->query("select user_id,businessname from tblusers where usertype_name='Distributor'");
