            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Submit Action OF FAIL SUCCESS</h4>
                                  ...
                                  <table class="table table-striped .table-bordered border" style="color:#000000;font-size:14px;font-family:sans-serif">
                                    <tr>
                                    	<td style="padding-right:10px;">
                                        	 <h5>Date : </h5>
                                            <input readonly class="form-control-sm" id="txtFrom" name="txtFrom" type="text" maxlength="12" style="width:120px;cursor:pointer" >
                                        </td>
                                        <td style="padding-right:10px;">
                                        	 <h5>Type : </h5>
                                        ...
                                        <td valign="bottom">
                                        <input type="submit" id="btnAction" name="btnAction" value="Submit" class="btn btn-primary">
                                        </td>
                                    </tr>
