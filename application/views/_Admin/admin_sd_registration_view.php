...
<html lang="en">
  <head>
        <title>WhiteLabel Registration</title>
    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
                      <div class="br-pageheader">
                        <nav class="breadcrumb pd-0 mg-0 tx-12">
                          ...
                          <span class="breadcrumb-item active">Super Distributor Registration Form</span>
                        </nav>
                      </div><!-- br-pageheader -->
                      <!-- d-flex -->
                         ...
                         <div class="row row-sm mg-t-20">
                                      <div class="col-sm-12 col-lg-12">
                                        <div class="card shadow-base bd-0">
                                          ...
                                          <form method="post" action="<?php echo base_url()."_Admin/admin_sd_registration"?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">  
