            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h4 class="text-themecolor m-b-0 m-t-0">RECEIVED MESSAGES</h4>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <nav class="breadcrumb">
                                    ...
                                    <span class="breadcrumb-item active">RECEIVED MESSAGES</span>
                                </nav>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form action="<?php echo base_url()."_Admin/received_message?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">                            <input type="hidden" id="hidID" name="hidID">                            <table cellspacing="10" cellpadding="3">                                     
                                    	<tr>                                     
                                            <td style="padding-right:10px;">                                         	 
                                            <h5>From Date</h5>                                             
                                            <input class="form-control-sm datepicker" id="txtFrom" name="txtFromDate" type="text" style="width:120px;cursor:pointer;" readonly placeholder="Select Date">                                         
                                            </td>                                     
                                            <td style="padding-right:10px;">                                         	 
                                            <h5>To Date</h5>                                             
                                            <input class="form-control-sm datepicker" id="txtTo" name="txtToDate" type="text" style="width:120px;cursor:pointer;" readonly placeholder="Select Date">                                         
                                            </td>                                        
                                            <td valign="bottom">                                         
