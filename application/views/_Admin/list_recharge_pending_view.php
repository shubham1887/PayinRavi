...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>PENDING RECHARGE REPORT</title>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">PENDING RECHARGE REPORT</span>
        </nav>
      </div><!-- br-pageheader -->
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-14 col-lg-14">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."_Admin/list_recharge_pending?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmsubmit" id="frmsubmit">
                           <input type="hidden" id="hidID" name="hidID">
                                    ...
                                    <form action="<?php echo base_url()."_Admin/list_recharge_pending?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
          ...
          <div class="col-sm-12 col-lg-12">
         	<div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">PENDING RECHARGE REPORT</h6>
                <span class="tx-12 tx-uppercase"></span>
              </div><!-- card-header -->
              <div class="card-body">
...
<td>
 ...
 <td>
     <a href="javascript:void()" onClick="openrecactionmodel('<?php echo $result->recharge_id; ?>')" class="btn btn-primary btn-sm">Action</a>
     <a id="btnResponseLog"  href="javascript:void()" onClick="getreqresplog('<?php echo $result->recharge_id; ?>')" class="btn btn-warning btn-sm">Response</a>
