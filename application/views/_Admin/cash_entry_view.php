...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
   ...
   <?php include("elements/sidebar.php"); ?><!-- br-sideleft -->
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pageheader">
        ...
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Cash Entry</span>
          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                ...
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">Cash Entry</h6>
    ...
    <form id="frmaddbal" name="frmaddbal" method="post" action="<?php echo base_url()."_Admin/Cash_entry?crypt=".$this->Common_methods->encrypt("MyData"); ?>" autocomplete="off" data-parsley-validate>
				...
				{
					var amt = document.getElementById("txtReceivedAmount").value;
					if(amt == "")
					{
						$("#txtReceivedAmount").addClass("error");
					...
					{
						$("#txtReceivedAmount").removeClass("error");
						//$("#err_amount").html("");
						return true;
					}
				}
