    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
            ...
            <?php include("elements/messagebox.php"); ?>
             <div class="row row-sm mg-t-20">
                   ...
                   <form method="post" action="<?php echo base_url()."_Admin/admin_d_registration?crypt=".$this->Common_methods->encrypt("MyData")?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">  
                                      ...
                                      <input style="width:300px;" type="text" class="form-control-sm" onKeyPress="return isNumeric(event);" placeholder="Enter Mobile No.<br />e.g. 9898980000" id="txtMobNo" name="txtMobNo" maxlength="10"  value="<?php echo $regData['mobile_no']; ?>"/> 
                                        ...
                                        <td>
                                        <h5>Select Parent: </h5>
                                        <select id="ddlparent" name="ddlparent" class="form-control-sm" style="width:300px;"> <option value="1">Select</option> <?php   $rlstparent = $this->db->query("select user_id,businessname from tblusers where usertype_name='MasterDealer'");  foreach($rlstparent->result() as $row)  {  ?>  <option value="<?php echo $row->user_id; ?>"><?php echo $row->businessname; ?></option>  <?php } ?> </select>  
                                        </td> 
                                      </tr> 
