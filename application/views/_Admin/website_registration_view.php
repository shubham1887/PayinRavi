    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
                      <div class="br-pageheader">
                        <nav class="breadcrumb pd-0 mg-0 tx-12">
                          ...
                          <span class="breadcrumb-item active">Website Registration Form</span>
                        </nav>
                      </div><!-- br-pageheader -->
                      <!-- d-flex -->
                                      ...
                                      <div class="col-sm-12 col-lg-12">
                                        <div class="card shadow-base bd-0">
                                          <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                                            <h6 class="card-title tx-uppercase tx-12 mg-b-0">Website Registration Form</h6>
                                          ...
                                          <form method="post" action="<?php echo base_url()."_Admin/Website_registration"?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">  
