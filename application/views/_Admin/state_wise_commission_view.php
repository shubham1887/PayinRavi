...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   ...
   <script language="javascript">
		...
		{
				$.ajax({
				url:'<?php echo base_url(); ?>_Admin/state_wise_commission/getresult?groupid='+document.getElementById("ddlgroup").value,
				method:'POST',
				cache:false,
		...
		$.ajax({
  url: '<?php echo base_url(); ?>_Admin/state_wise_commission/changecommission?company_id='+document.getElementById("ddlgroup").value+'&com='+com+'&circle_id='+id+'&mincom=0&maxcom=0&comtype='+comtype,
  type: 'POST',
