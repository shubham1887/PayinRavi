    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
					  <div class="br-pageheader">
						<nav class="breadcrumb pd-0 mg-0 tx-12">
						  ...
						  <span class="breadcrumb-item active">Dmt_slabs</span>
						</nav>
					  </div><!-- br-pageheader -->
					  <!-- d-flex -->
					   <div class="br-pagetitle">
						<div>
						 <h3 class="page-header">Set Margin Slab For Group : <?php echo $this->Common_methods->decrypt($this->input->get("crypt1")); ?></h3>
						</div>
					  </div>
									  ...
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											<h6 class="card-title tx-uppercase tx-12 mg-b-0">Dmt_slabs List</h6>
              ...
              <thead class="thead-colored thead-primary" >
												<tr><th>Group</th><th>AmountFrom</th><th>AmountTo</th><th>charge_type</th><th>charge_amount</th>
		            <th>DateTime</th>
				    <th></th>
	            </tr>
				</thead>
				...
				foreach($data->result() as $row)
                              ...
                              <td class="hidden-480"><?php echo $row->Name; ?>
                		        <input type="hidden" id="hidgroup_id<?php echo $row->Id;?>" value="<?php echo $row->group_id; ?>">
                                </td>
                              <td class="hidden-480"><?php echo $row->range_from; ?>
                		        <input type="hidden" id="hidrange_from<?php echo $row->Id;?>" value="<?php echo $row->range_from; ?>">
                                </td>
                              <td class="hidden-480"><?php echo $row->range_to; ?>
                		        <input type="hidden" id="hidrange_to<?php echo $row->Id;?>" value="<?php echo $row->range_to; ?>"></td>
                              <td class="hidden-480"><?php echo $row->charge_type; ?>
                		        <input type="hidden" id="hidcharge_type<?php echo $row->Id;?>" value="<?php echo $row->charge_type; ?>"></td>
                              <td class="hidden-480"><?php echo $row->charge_amount; ?>
                		        <input type="hidden" id="hidcharge_amount<?php echo $row->Id;?>" value="<?php echo $row->charge_amount; ?>"></td>
							  ...
							  <td>
								  ...
								  document.getElementById("ddlgroup").value =  document.getElementById("hidgroup_id"+id).value;
								  ...
								  document.getElementById("txtcharge_type").value =  document.getElementById("hidcharge_type"+id).value;
								  document.getElementById("txtcharge_amount").value =  document.getElementById("hidcharge_amount"+id).value;
													}
													</script></div>
            									</div>
        								</div>
												...
												<div class="row">
													...
													<input type="hidden" id="hidPrimaryId" name="hidPrimaryId">
                                                                        ...
                                                                        <div class="form-group">
																            ...
																            <div>
																	            <select id="ddlgroup" name="ddlgroup" class="form-control-sm">
                                                                                <option value="0"></option>
                                                                                <?php
																					$rsltgroupinfo = $this->db->query("select * from mt3_group order by Name");
																					foreach($rsltgroupinfo->result() as $rwgp)
																					{?>
                                                                                    <option value="<?php echo $rwgp->Id; ?>"><?php echo $rwgp->Name; ?></option>
																					<?php }
																				 ?>
                                                                                </select>
																            </div>
																        ...
																        <div class="form-group">
																            <label for="form-field-select-3">AmountFrom</label>
																            <div>
																	            <input type="text" name="txtAmountFrom" id="txtAmountFrom" class="form-control-sm">
																            </div>
															            </div>
															            <div class="space-4"></div>
																        <div class="form-group">
																            <label for="form-field-select-3">AmountTo</label>
																            <div>
																	            <input type="text" name="txtAmountTo" id="txtAmountTo" class="form-control-sm">
																            </div>
															            </div>
															            <div class="space-4"></div>
															
																<div class="form-group">
																<label for="form-field-select-3">charge_type</label>
																<div>
																	<select name="txtcharge_type" id="txtcharge_type" class="form-control-sm">
																	<option value="0">Select</option><option value='AMOUNT'>AMOUNT</option><option value='PER'>PER</option>
															...
															<div class="space-4"></div>
																        ...
																        <div class="form-group">
																            <label for="form-field-select-3">charge_amount</label>
																            <div>
																	            <input type="text" name="txtcharge_amount" id="txtcharge_amount" class="form-control-sm">
																            </div>
															            </div>
															            <div class="space-4"></div>
														<?php echo form_close();?>
