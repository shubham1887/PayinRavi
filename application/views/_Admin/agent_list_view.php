...
function startexoprttwo2()
{
  document.getElementById("frmexport").submit();
    ...
    <tr>
     ...
     <th style="width: 80px;">ER Balance</th> 
     <th style="width: 80px;">DMT Balance</th> 
     <th style="width: 80px;">AepsBalance</th> 
 ...
 <td><?php echo $i+1; ?></td>
 <td ><?php echo $result->md_name; ?> <br> <?php echo $result->md_username; ?></td>
 <td ><?php echo $result->parent_username; ?> <BR><a href="<?php echo base_url()."_Admin/profile?usertype=".$this->Common_methods->encrypt("Distributor")."&user_id=".$this->Common_methods->encrypt($result->parentid);?>" target="_blank"><?php echo $result->parent_name; ?></a></td>
 
<td ><?php echo $result->username; ?><BR><a href="<?php echo base_url()."_Admin/profile?usertype=".$this->Common_methods->encrypt("Agent")."&user_id=".$this->Common_methods->encrypt($result->user_id);?>" target="_blank"><?php 
...
<td><span id="spanbalance_DMT<?php echo $result->user_id; ?>"></span></td>
...
<td>
  <?php echo $result->kyc;?>
<?php if($result->kyc == "yes")
{?>
        <input checked type="checkbox" id="chkkyc<?php echo $result->user_id; ?>" onClick="updatekyc(<?php echo $result->user_id; ?>)">
<?php }
else
{?>
  <input type="checkbox" id="chkkyc<?php echo $result->user_id; ?>" onClick="updatekyc(<?php echo $result->user_id; ?>)">
<?php } ?>
</td>
...
{       
    ...
    {               
        $.ajax({        
            url:'<?php echo base_url()."_Admin/agent_list/setvalues?"; ?>Id='+id+'&field=KYC&val=yes',         
            cache:false,        
            method:'POST',        
            success:function(html)        
            {           
    ...
    {                     
        $.ajax({        
            url:'<?php echo base_url()."_Admin/agent_list/setvalues?"; ?>Id='+id+'&field=KYC&val=no',         
            cache:false,        
            method:'POST',        
            success:function(html)        
            {           
