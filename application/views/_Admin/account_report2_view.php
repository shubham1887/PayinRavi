...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>DMT ACCOUNT REPORT</title>
...
<input type="hidden" id="hidgetlogurl" value="<?php echo base_url()."_Admin/getdmtlogs"; ?>">
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">DMT ACCOUNT REPORT</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="br-pagetitle">
        <div class="col-md-5 col-8 align-self-center">
                        <h4 class="text-themecolor m-b-0 m-t-0">DMT ACCOUNT REPORT</h4>
  ...
  <div class="row row-sm mg-t-20">
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                 <form action="<?php echo base_url()."_Admin/Account_report2?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmReport" id="frmReport">
            <table class="table">
            <tr>
                <td>
        ...
        <div class="row row-sm mg-t-20">
          ...
          <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">DMT ACCOUNT REPORT</h6>
                <span class="tx-12 tx-uppercase"></span>
              </div><!-- card-header -->
              <div class="card-body">
 ...
 <table class="table table-bordered table-striped" style="color:#00000E">
      ...
      {
         if ($result->transaction_type == "PAYMENT" or $result->transaction_type == "COMMISSION" or $result->transaction_type == "CRADIT" or $result->transaction_type == "DEBIT" ) {
        if(($result->debit_amount > 0 and $result->transaction_type) or ($result->credit_amount > 0))
        { 
      ?>   
 ...
 <td ><?php if ($result->credit_amount != "0") {echo round($result->credit_amount,2); } else{echo "";}?></td>
  ...
  <td ><?php if ($result->debit_amount != "0") {echo round($result->debit_amount,2); } else{echo "";}?></td> 
