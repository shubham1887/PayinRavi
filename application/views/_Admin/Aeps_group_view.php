...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Aeps Commission Slab</title>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Aeps Commission Slabs</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="br-pagetitle">
        <div>
          <h4>Aeps Commission Slabs</h4>
        </div>
      </div><!-- d-flex -->
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form role="form" method="post" action="<?php echo base_url()."_Admin/Aeps_group?crypt=".$this->Common_methods->encrypt("MyData"); ?>">                            
                    ...
                    <form id="frmDelete" name="frmDelete" action="<?php echo base_url()."_Admin/Aeps_group"; ?>" method="post"> 								
          ...
          <div class="col-sm-12 col-lg-12">
         	<div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">Aeps Group List</h6>
                <span class="tx-12 tx-uppercase"></span>
              </div><!-- card-header -->
              <div class="card-body">
                <table class="table table-striped" style="color:#000000;font-weight:normal;font-family:sans-serif;font-size:14px;overflow:hidden">
                                    ...
                                    <a href="<?php echo base_url()."_Admin/Aeps_group?crypt1=".$this->Common_methods->encrypt($row->Name)."&crypt2=".$this->Common_methods->encrypt($row->Id); ?>" target="_blank"> 													
