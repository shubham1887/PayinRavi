    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
					  <div class="br-pageheader">
						<nav class="breadcrumb pd-0 mg-0 tx-12">
						  ...
						  <a class="breadcrumb-item" href="#">MasterEntry</a>
              ...
              <thead class="thead-colored thead-primary" >
				...
				<tbody><?php foreach($data->result() as $row)
						      { ?><tr><td class="hidden-480"><?php echo $row->state_name; ?>
                		        <input type="hidden" id="hidstate_name<?php echo $row->state_id;?>" value="<?php echo $row->state_name; ?>"></td><td class="hidden-480"><?php echo $row->add_date; ?></td>
											<td>
												<div class="hidden-sm hidden-sm btn-group">
												    <button class="btn btn-sm btn-success">
													<i class="ace-icon fa fa-check bigger-120"></i>															</button>

													<button class="btn btn-sm btn-info" onClick="editform(<?php echo $row->state_id; ?>)" href="#modal-form" data-toggle="modal">
													<i class="ace-icon fa fa-pencil bigger-120"></i>Edit	
													</button>
												

													<button class="btn btn-sm btn-danger" onClick="deletitem(<?php echo $row->state_id; ?>)" href="#modal-formdelete" data-toggle="modal">
													...
													function editform(id)
													{
														...
														document.getElementById("hidPrimaryId").value =  id;
								  document.getElementById("HIDACTION").value =  "UPDATE";document.getElementById("txtStateName").value =  document.getElementById("hidstate_name"+id).value;
													}
													</script></div>
            									</div>
        								</div>
												...
												<div class="row">
													...
													<input type="hidden" id="hidPrimaryId" name="hidPrimaryId">
																        ...
																        <div class="form-group">
																            ...
																            <div>
																	            <input type="text" name="txtStateName" id="txtStateName" class="form-control">
																            </div>
															            </div>
