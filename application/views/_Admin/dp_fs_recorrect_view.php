            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">FS Recorrect</h3>
                         <li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Enter Recharge Id</h4>
                                  ...
                                  <table class="table table-striped .table-bordered border" style="color:#000000;font-size:14px;font-family:sans-serif">
                                    <tr>
                                    	<td style="padding-right:10px;">
                                        	 <h5>Enter Recharge Id</h5>
                                            <input class="form-control-sm" id="txtRechargeId" name="txtRechargeId" type="text" maxlength="12" style="width:120px;" >
                                        </td>
                                        <td valign="bottom">
