						 ...
						 <div class="row row-sm mg-t-20">
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  ...
										  <div class="card-body">
                                        <form method="post" action="<?php echo base_url()."_Admin/sd_edit?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
...
<tr>
    ...
    <td>
        <select style="width:300px;height:30px;" class="text" id="ddlSchDesc" onChange="ChangeAmount()" placeholder="Select Scheme Name.Click on drop down" name="ddlSchDesc">
          ...
          <?php
            $str_query = "select * from tblgroup where groupfor = 'SuperDealer'";
