...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>DMR RESEND TRANSACTIONS</title>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">DMR RESEND TRANSACTIONS</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="br-pagetitle">
       <div class="col-sm-6 col-lg-3">
          <h4>DMR RESEND TRANSACTIONS</h4>
        </div>
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                 <form action="<?php echo base_url()."_Admin/Dmr_resend_transactions?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmReport" id="frmReport">
            <table class="table">
            <tr>
            	<td>
				...
				<td >
                	<label></label>
							...
							<form id="frmexport" name="frmexport" action="<?php echo base_url()."_Admin/Dmr_resend_transactions/dataexport" ?>" method="get">
