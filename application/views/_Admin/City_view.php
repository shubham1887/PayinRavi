    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
									  ...
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											<h6 class="card-title tx-uppercase tx-12 mg-b-0">City List</h6>
              ...
              <thead class="thead-colored thead-primary" >
				...
				<tbody><?php foreach($data->result() as $row)
						      { ?><tr><td class="hidden-480"><?php echo $row->city_name; ?>
                		        <input type="hidden" id="hidcity_name<?php echo $row->city_id;?>" value="<?php echo $row->city_name; ?>"></td><td class="hidden-480"><?php echo $row->tblstate_state_name; ?>
                		        <input type="hidden" id="hidstate_id<?php echo $row->city_id;?>" value="<?php echo $row->state_id; ?>"></td><td class="hidden-480"><?php echo $row->add_date; ?></td>
											<td>
												<div class="hidden-sm hidden-sm btn-group">
												    <button class="btn btn-sm btn-success">
													<i class="ace-icon fa fa-check bigger-120"></i>															</button>

													<button class="btn btn-sm btn-info" onClick="editform(<?php echo $row->city_id; ?>)" href="#modal-form" data-toggle="modal">
													<i class="ace-icon fa fa-pencil bigger-120"></i>Edit	
													</button>
												

													<button class="btn btn-sm btn-danger" onClick="deletitem(<?php echo $row->city_id; ?>)" href="#modal-formdelete" data-toggle="modal">
													...
													function editform(id)
													{
														...
														document.getElementById("hidPrimaryId").value =  id;
								  document.getElementById("HIDACTION").value =  "UPDATE";document.getElementById("txtCityName").value =  document.getElementById("hidcity_name"+id).value;document.getElementById("txtStateName").value =  document.getElementById("hidstate_id"+id).value;
													}
													</script></div>
            									</div>
        								</div>
												...
												<div class="row">
													...
													<input type="hidden" id="hidPrimaryId" name="hidPrimaryId">
																        ...
																        <div class="form-group">
																            <label for="form-field-select-3">CityName</label>
																            <div>
																...
																<div class="form-group">
																<label for="form-field-select-3">StateName</label>
																<div>
																	<select name="txtStateName" id="txtStateName" class="form-control">
