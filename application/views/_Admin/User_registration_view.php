						...
						<?php include("elements/messagebox.php"); ?>
						 <div class="row row-sm mg-t-20">
                                    ...
                                    <tbody> 
                                        ...
                                        <td> 	
                                        	<h5>GST Number :</h5> 		
                                        	<input style="width:300px;" type="text" class="form-control-sm" id="txtGst"  name="txtGst"  maxlength="15" value="<?php echo $regData['gst']; ?>"/> 	
                                        </td> 	
                                        <td>  		
                                        	<h5>Group :</h5> 					
                                            	<select style="width:300px;" class="form-control-sm" id="ddlSchDesc"  name="ddlSchDesc"> 						  
