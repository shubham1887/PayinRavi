				...
				<tbody><?php foreach($result_group->result() as $row)
                  ...
                  <tr>
                  	<td class="hidden-480"><?php echo $row->group_name; ?>
                		        <input type="hidden" id="hidName<?php echo $row->Id;?>" value="<?php echo $row->group_name; ?>"></td>
                    <td class="hidden-480">
					    <span  id="charge_type_<?php echo $row->Id; ?>">
							<?php echo $row->groupfor; ?>
						</span>
						<input type="hidden" id="hidcharge_type<?php echo $row->Id;?>" value="<?php echo $row->groupfor; ?>">
                    </td>
                    
                    
                    <td class="hidden-480">
					    <span>
							<?php echo $row->businessname; ?><br><?php echo $row->usertype_name; ?>
						</span>
													...
													<input type="hidden" id="hidPrimaryId" name="hidPrimaryId">
																...
																<div>
																	<select name="ddlgroupfor" id="ddlgroupfor" class="form-control">
    																	...
    																	<option value="SuperDealer">SuperDealer</option>
																	</select>
