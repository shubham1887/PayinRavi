    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">PG REPORT</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="br-pagetitle">
        <div class="col-md-5 col-8 align-self-center">
                        <h4 class="text-themecolor m-b-0 m-t-0">PG REPORT</h4>
  ...
  <div class="row row-sm mg-t-20">
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                 <form action="<?php echo base_url()."_Admin/Pg_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmReport" id="frmReport">
            <table class="table">
            <tr>
                <td>
                ...
                <td >
                    <label></label>
                            ...
                            <form id="frmexport" name="frmexport" action="<?php echo base_url()."_Admin/Pg_report/dataexport" ?>" method="get">
        ...
        <div class="row row-sm mg-t-20">
          <div class="col-sm-12 col-lg-12">
            <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">PG REPORT</h6>
                <span class="tx-12 tx-uppercase"></span>
              </div><!-- card-header -->
              <div class="card-body">
...
<td >
 ...
 <td><?php echo "<span id='db_date".$i."'>".$result->dist_businessname."<br>[".$result->dist_mobile_no."]"."</span>"; ?></td>
  ...
  <td><?php echo "<span id='db_date".$i."'>".$result->businessname."<br>[".$result->mobile_no."]"."</span>"; ?></td>
   ...
   <td><?php echo "<span id='db_date".$i."'>".$result->phone."<br>[".$result->email."]"."</span>"; ?></td>

   <td><?php echo "<span id='db_date".$i."'>".$result->method."</span>"; ?></td>
 <td>
     <?php
     if ($result->vpa == true) {
        echo "<span id='db_date".$i."'>".$result->vpa."</span>"; 
     }else{
        echo "<span id='db_date".$i."'>".$result->card_type."<br>[".$result->card_network."]"."<br>[".$result->card_name."]</span>";
     }
      ?>
 </td>
   <td><?php echo "<span id='db_date".$i."'>".$result->amount."</span>"; ?></td>
   <td><?php echo "<span id='db_date".$i."'>".$result->charges."</span>"; ?></td>
   <td><?php echo "<span id='db_date".$i."'>".$result->order_id."</span>"; ?></td>
   <td><?php echo "<span id='db_date".$i."'>".$result->razorpay_payment_id."</span>"; ?></td>
  
 

 <td>
 
  <?php if($result->status == "captured"){echo "<span class='btn btn-success btn-sm'>SUCCESS</span>";} ?>
  <?php if($result->status == "FAILED"){echo "<span class='btn btn-danger btn-sm'>".$result->status."</span>";} ?>
 </td>
