...
<body class="fix-header card-no-border logo-center">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h4 class="text-themecolor m-b-0 m-t-0">Balance Transfer</h4>
	...
	?>    
    <fieldset>
    <form id="frmaddbal" name="frmaddbal" method="post" action="<?php echo base_url()."_Admin/add_balance?crypt=".$this->Common_methods->encrypt("MyData"); ?>">
                	  <input type="hidden" id="hidid" name="hidid" value="<?php echo $userinfo->row(0)->user_id; ?>">
					
                	  <table class="" style="width:450px">
                                    <tr>
