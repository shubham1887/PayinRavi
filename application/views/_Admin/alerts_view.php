            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Set Alert Here</h4>
                                <div class="table-responsive">
                                                <form action="<?php echo base_url()."_Admin/alerts"; ?>" method="post" autocomplete="off" name="frmService" id="frmService">     <fieldset>     <table width="100%" border="0" cellspacing="3" cellpadding="3">     <tr>   <td>       <textarea cols="100" id="editor1" name="editor1" rows="10">       <?php 		$str_query = "select * from tblalerts"; 		$result = $this->db->query($str_query);		 		 		echo html_entity_decode($result->row(0)->alert_name); 	?>         </textarea> 		<script type="text/javascript"> 		//<![CDATA[ 			// Replace the <textarea id="editor1"> with an CKEditor instance. 			var editor = CKEDITOR.replace( 'editor1' ); 		//]]> 		</script>   </td>   </tr>   <tr>     <td align="center">     <input type="submit" class="btn btn-primary" value="Set Alert" name="btnSubmit" id="btnSubmit" />     </td>     </tr> </table> </fieldset> </form>
                                </div>
                            </div>
                        </div>
                    </div>
