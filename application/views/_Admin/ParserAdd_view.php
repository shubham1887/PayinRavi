...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<title>Add Response Parser</title>
    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
					  <div class="br-pageheader">
						<nav class="breadcrumb pd-0 mg-0 tx-12">
						  ...
						  <span class="breadcrumb-item active">Response Parser</span>
						</nav>
					  </div><!-- br-pageheader -->
					  <!-- d-flex -->
									  ...
									  <div class="col-sm-12 col-lg-12">
										<div class="card shadow-base bd-0">
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											<h6 class="card-title tx-uppercase tx-12 mg-b-0">Response Parser List</h6>
              ...
              <thead class="thead-colored thead-primary" >
				...
				<tbody><?php foreach($result_group->result() as $row)
						      { ?>
                  <tr>
                  	<td class="hidden-480"><?php echo $row->parser_name; ?>
                		        <input type="hidden" id="hidName<?php echo $row->Id;?>" value="<?php echo $row->parser_name; ?>"></td>
