    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">INDO-NEPAL REPORT</span>
        </nav>
      </div><!-- br-pageheader -->
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-14 col-lg-14">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url();?>_Admin/IndoNepal_report" method="post" name="frmsubmit" id="frmsubmit">
                           <input type="hidden" id="hidID" name="hidID">
                                    ...
                                    <form action="<?php echo base_url();?>_Admin/IndoNepal_report" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
          ...
          <div class="col-sm-12 col-lg-12">
         	<div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">IndoNepal REPORT</h6>
                <span class="tx-12 tx-uppercase"></span>
              </div><!-- card-header -->
              <div class="card-body">
  ...
  <td><?php echo $result->aTrnsactionId; ?></td>
 ...
 <td>
  <?php echo $result->SenderName; ?><br>
  <?php echo $result->SenderMobile; ?><br>
    
  </td>
 <td>
  <?php echo $result->ReceiverName; ?><br>
  <?php echo $result->ReceiverMobile; ?><br>
 </td>

 <td style="min-width: 200px;">
  SendAmount : <?php echo $result->SendAmount; ?><br>
  Cole.Amount : <?php echo $result->CollectedAmount; ?><br>
  Payout.Amount : <?php echo $result->PayAmount; ?><br>
  ServiceCharge : <?php echo $result->ServiceCharge; ?><br>
    

  </td>

 
 <td id="tdstatus<?php echo $result->Id; ?>">
 <?php 
 if($result->status == 'Pending'){echo "<span class='label btn-warning'>Pending</span>";}
 if($result->status == 'Success')
 {
    echo "<span class='label btn-success'>Success</span>";
 }
 ...
 <td id="stsverify<?php echo $result->Id; ?>">
 <?php 
 if($result->verify_status == 'Pending'){echo "<span class='label btn-warning'>Pending</span>";}
 if($result->verify_status == 'Success')
 {
    echo "<span class='label btn-success'>Success</span>";
 }
 if($result->verify_status == 'Failure')
 {
    echo "<span class='label btn-danger'>Failure</span>";
 }
...
<td><?php echo $result->aMessage; ?></td>

 <td>
     <a style="width:70px;max-width:70px;" href="javascript:void()" onClick="openrecactionmodel('<?php echo $result->Id; ?>')" class="btn btn-primary btn-sm">Action</a>
     <a id="btnResponseLog" style="width:70px;max-width:70px;" href="javascript:void()" onClick="getreqresplog('<?php echo $result->Id; ?>')" class="btn btn-warning btn-sm">Response</a>
