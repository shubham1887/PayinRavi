...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script language="javascript">
        ...
        var totalapibalance = 0;
        function allbalancesum(balance)
        {
        	totalapibalance = (+totalapibalance + +balance);
        	document.getElementById("SpanTotalApiBalance").innerHTML = totalapibalance;
        }
                ...
                <div class="card-body pd-0">
                   <div class="card-body">
                                ...
                                <tr class="btn-primary">
                                	...
                                	<td align="center"><span id="SpanTotalApiBalance"></span></td>
                                	<td></td>
                                	<td></td>
                                </tr>
