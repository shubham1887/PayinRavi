                           ...
                           <table class="table table-bordered table-striped" style="color:#00000E">
                                    ...
                                    <tr> 
                               		...
                               		<tr> 
                                        ...
                                        <td>
                                            <label> Amount :</label>
                                            <input type="number" class="form-control-sm" id="txtAmount" name="txtAmount"  maxlength="10"/> 
                                        </td> 
                                        <td>
                                            <label> Remark :</label>
                                            <input type="text" class="form-control-sm" id="txtRemark" name="txtRemark"  maxlength="120"/> 
                                        </td>
                                    ...
                                    <tr> 
                                        <td colspan="2">
                                        	<input type="submit" id="btnSubmit" name="btnSubmit" value="Submit" class="btn btn-success" style="width:200px;"> 
