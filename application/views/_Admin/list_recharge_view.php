      ...
      <div class="br-pagetitle">
        ...
        <div class="col-sm-6 col-lg-12">
            ...
            <span class="breadcrumb-item">
             ...
             <span class="breadcrumb-item">
                <button class="btn btn-info btn-sm" type="button" style="font-size:14px;">FlatComm : <?php echo $flatcommission; ?></button>
            </span>
            ...
            <span class="breadcrumb-item active">
             ...
             <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:14px;">OTF : <?php echo $roffer; ?></button>
            </span>
            <br>
            <br>
            
            <span class="breadcrumb-item active">
          	    <button class="btn btn-success btn-sm" type="button" style="font-size:14px;">Profit : <?php echo ($AdminComm + $roffer) - ($retComm + $DComm + $MdComm + $flatcommission); ?></button>
            </span>
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
 ...
 <td style="width:120px;min-width:120px;font-weight:bold;color:#3366cc;font-size:16px;font-family:sans-serif"><?php echo $result->businessname; ?><br><?php echo $result->username; ?></td>
