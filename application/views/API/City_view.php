              ...
              <thead class="thead-colored thead-primary" >
				...
				<tbody><?php foreach($data->result() as $row)
						      { ?><tr><td class="hidden-480"><?php echo $row->city_name; ?>
                		        <input type="hidden" id="hidcity_name<?php echo $row->Id;?>" value="<?php echo $row->city_name; ?>"></td><td class="hidden-480"><?php echo $row->tblstate_state_name; ?>
                		        <input type="hidden" id="hidstate_id<?php echo $row->Id;?>" value="<?php echo $row->state_id; ?>"></td><td class="hidden-480"><?php echo $row->add_date; ?></td>
											<td>
