...
<?php echo $result->order_id;?>
 ...
 {
    echo "<span class='btn btn-primary btn-sm' id='db_status".$result->Id."' >".$result->Status."</span>";
 } ?>
  ...
  <td align="center"><a href="javascript:void(0)" style="height:15px;width:20px;" onClick="javascript:complainadd('<?php echo $result->Id; ?>')" > Complain</a></td>
  </tr>
		<?php
