...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Wallet 2 Account Report</title>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">WALLET 2 ACCOUNT REPORT</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="br-pagetitle">
        <div>
          <h4>WALLET 2 ACCOUNT REPORT</h4>
        </div>
      </div><!-- d-flex -->
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."API/Account_report2" ?>" method="post" name="frmCallAction" id="frmCallAction">
          ...
          <div class="col-sm-12 col-lg-12">
         	<div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">WALLET 2 ACCOUNT REPORT</h6>
                <span class="tx-12 tx-uppercase"></span>
              </div><!-- card-header -->
              <div class="card-body">
