...
$(document).ready(function(){
	...
	function setLoadValues()
	{
		...
		document.getElementById('ddlSchDesc').value = '<?php echo $result_user->row(0)->scheme_id; ?>';
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pageheader">
        ...
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Distributor Edit</span>
...
<tbody>
<tr>
<td>Distributer Name :<input readonly type="text" class="form-control" placeholder="Enter Retailer Name." id="txtDistname" name="txtDistname" value="<?php echo $result_user->row(0)->businessname; ?>"  maxlength="100" style="width:300px;"/>
</td>
<td>
	</td>
</tr>
