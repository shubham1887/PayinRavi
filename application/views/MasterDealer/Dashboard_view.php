...
<html lang="en">
  ...
  <head>
    ...
    <title>MasterDealer | DASHBOARD</title>
          ...
          <div class="col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-footer tx-12 pd-y-15 bg-transparent">
                ...
                <a href="<?php echo base_url()."MasterDealer/Dmr_report?crypt=".$this->Common_methods->getAgentBalance($this->session->userdata("ApiId")); ?>"><i class="fa fa-angle-down mg-r-5"></i>View All Transaction History</a>
    ...
    <script src="<?php echo base_url(); ?>js/widgets.js"></script>
...

		{
			...
			$.ajax({
					...
					url: '<?php echo base_url(); ?>MasterDealer/Dashboard/getSummary',
...

		{
			...
			$.ajax({
					...
					url: '<?php echo base_url(); ?>MasterDealer/Dashboard/getLastTransactions',
