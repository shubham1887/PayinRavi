    ...
    <!-- ########## END: RIGHT PANEL ########## ---><div class="br-mainpanel">
					  ...
					  <div class="br-pageheader">
						...
						<nav class="breadcrumb pd-0 mg-0 tx-12">
						  ...
						  <span class="breadcrumb-item active">CHANGE TRANSACTION PASSWORD</span>
      				 ...
      				 <div class="br-pagebody">
						...
						<?php include("elements/messagebox.php"); ?>
						 ...
						 <div class="row row-sm mg-t-20">
									  ...
									  <div class="col-sm-12 col-lg-12">
										...
										<div class="card shadow-base bd-0">
										  ...
										  <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
											...
											<h6 class="card-title tx-uppercase tx-12 mg-b-0">CHANGE TRANSACTION PASSWORD FORM</h6>
									 ...
									 <form role="form" method="post" action="<?php echo base_url()."MasterDealer/change_txnpassword"; ?>">
