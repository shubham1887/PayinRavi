                    ...
                    <div class="col-lg-4 col-9">
                        <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">Bill Payment History</a></li>
                            </ol>
                        </nav>
                    </div>
                                                ...
                                                <form class="form-group mg-t-0">
                                                    <div id="dateragne-picker21">
                                                        <div class="input-daterange input-group">
                                                            <input  autocomplete="off" class="form-control" id="FromDate" name="FromDate" placeholder="From Date" required="required" type="text" value="<?php echo $FromDate; ?>" />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                            <input  autocomplete="off" class="form-control" id="ToDate" name="ToDate" placeholder="To Date" required="required" type="text" value="<?php echo $ToDate; ?>" />
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                    ...
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters" class="ng-scope">
                                                        ...
                                                        <td style="white-space: nowrap;">
                                                           ...
                                                           <?php  
                                                            ...
                                                            {?>
                                                                <span class="success ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barSuccess"></span><?php echo "Success"; ?></span>
                                                            <?php }
                                                            else
                                                            {?>
                                                                ...
                                                                <span data-ng-if="item.TxnStatus==='Success'" class="ng-scope">
                                                                    <a href="#" data-tooltip="Click to raise complaint" data-ng-click="puttransactioncomplain(item);" class="ng-binding">
                                                                        ...
                                                                        <?php
                                                                            if($result->status == "Pending" or $result->status == "PENDING")
                                                                        {?>
                                                                            <?php echo date_format(date_create($result->add_date),'YmdHis'); ?>
                                                                        <?php } 
                                                                        else 
                                                                        { 
                                                                            echo $result->opr_id; 
