    ...
    <div class="row">
        <div class="col-md-3 col-12">
            <div class="card" style="min-height:initial;">
                <form action="<?php echo base_url();?>Retailer/UserProfile/UserProfileUpload" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body text-center pd-t-10">
                        ...
                        <div class="editable-on-click" style="display:block; position:relative">
                            ...
                            <img class="img-fluid" style="height:65px;border-radius:50%;margin-bottom:10px;" src="<?php echo base_url().$userdata->row(0)->profile_pic_path; ?>" />
                        </div>
                        <h5>sai store</h5>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-6 pd-0 pd-5">
                            <?php
                                ...
                                <?php }
                                else if(strlen($userdata->row(0)->Document1) > 5)
                                {?>
                                    <img src="<?php echo base_url().str_replace("images","uploads",$userdata->row(0)->Document1); ?>" class="img-fluid" style="height: 210px;" />
                                <?php }
                             ?>
                        ...
                        <div class="col-md-6 pd-0 col-lg-6 col-6 pd-5 b-l">
                            <?php
                                ...
                                <?php }
                                 else if(strlen($userdata->row(0)->Document2) > 5)
                                {?>
                                    <img src="<?php echo base_url().str_replace("images","uploads",$userdata->row(0)->Document2); ?>" class="img-fluid" style="height: 210px;" />
                                <?php }
                             ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-12 text-center">
                            <?php
                                ...
                                <?php }
                                 else if(strlen($userdata->row(0)->Document3) > 5)
                                {?>
                                    <img src="<?php echo base_url().str_replace("images","uploads",$userdata->row(0)->Document3); ?>" class="img-fluid" style="height: 210px;" />
                                <?php }
...
<form action="<?php echo base_url(); ?>Retailer/UserProfile" method="post"><input name="__RequestVerificationToken" type="hidden" value="_InD7fTISQpE9nYTkn5UtfiIk5dtYc1b7ZU5OuxqFkvru9IUKhEbfYhikd6QCm_60i80eLKpRg-Bv_y8e919S7ezkqnbylZ8soaGHCkIPCc1" /><input data-val="true" data-val-number="The field RefrenceNumber must be a number." data-val-required="The RefrenceNumber field is required." id="RefrenceNumber" name="RefrenceNumber" type="hidden" value="2185" /><input data-val="true" data-val-number="The field WhiteUser must be a number." data-val-required="The WhiteUser field is required." id="WhiteUser" name="WhiteUser" type="hidden" value="5" />                            
        <div class="row">
                                 ...
                                 <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="inputText">
                                            <input class="form-control" data-val="true" data-val-maxlength="The field FirmName must be a string or array type with a maximum length of &#39;30&#39;." data-val-maxlength-max="30" data-val-regex="Valid characters: Alphabets and min 3." data-val-regex-pattern="[a-zA-Z]{3,30}$" data-val-required="First Name is required." id="FirmName" name="FirmName" placeholder="Enter Firm Name" required="" type="text" value="<?php echo $userdata->row(0)->businessname ?>" />
