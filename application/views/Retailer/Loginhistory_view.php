                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body pd-xs-10">
                            <form action="<?php echo base_url(); ?>Retailer/Loginhistory" method="post">
                                <input name="__RequestVerificationToken" type="hidden" value="H5ffOV2HB38yZiizAk6XVHFaxIshXvwTQ4ujN__L5mbj73r62PcpOyFzfbgCbX_aLUa29FAtsqtsewuAD4zUCXd0U82-iBRcfqQEhrrX1XY1" />
                                <div class="row">
                                    <div class="col-md-5 col-10 col-lg-5 col-sm-5 form-group">
                                        <div id="dateragne-picker21">
                                            <div class="input-daterange input-group">
                                                <input type="text" class="form-control" id="Fromdate" name="Fromdate" placeholder="From Date" autocomplete="off" required="" maxlength="15" />
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                </div>
                                                <input type="text" class="form-control" id="Todate" name="Todate" placeholder="To Date" autocomplete="off" required="" maxlength="15" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-2 col-lg-4 col-sm-3 pd-xs-l-0">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> </button>
                                    </div>
                                    <div class="col-md-4 col-xs-12 col-lg-3 col-sm-4 pull-right">
                                ...
                                <div class="col-md-12 table-responsive">
                                    <table class="table table-striped table-transaction">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=1;
                                            foreach($myhistory->result() as $rw)
                                            {
                                             ?>
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
                                                            <td>
                                                                <?php echo $rw->ipaddress; ?>
                                                            </td>
                                                            <td>
