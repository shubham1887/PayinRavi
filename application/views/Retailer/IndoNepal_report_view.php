                ...
                <div class="row align-items-center py-3">
                    <div class="col-lg-4 col-9">
                        <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">IndoNepal History</a></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-8 col-3 text-right">
                        <div class="page-header">
                                ...
                                <div class="card-action pull-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item success"><b>Total  Send Success : <?php echo $summary_array["PayAmountsus"]; ?></b></a>
                                            <a class="dropdown-item failure"><b>Total Failed : <?php echo $summary_array["PayAmountfailed"]; ?></b></a>
                                            <a class="dropdown-item pending"><b>Total Pending : <?php echo $summary_array["PayAmountpen"]; ?></b></a>

                                            <a class="dropdown-item totAmount"><b>Total  Send Amount : <?php echo $summary_array["SendAmount"]; ?></b></a>
                                            <a class="dropdown-item totAmount"><b>Total Charge : <?php echo $summary_array["ServiceCharge"]; ?></b></a>
                                            <a class="dropdown-item totAmount"><b>Total Amount : <?php echo $summary_array["PayAmount"]; ?></b></a>
                                        </div>
                            ...
                            <div class="ml-auto">
                                <a class="success"><b>Total  Send Success : <?php echo $summary_array["PayAmountsus"]; ?></b></a>
                                <a class="failure"><b>Total Failed : <?php echo $summary_array["PayAmountfailed"]; ?></b></a>
                                <a class="pending"><b>Total Pending : <?php echo $summary_array["PayAmountpen"]; ?></b></a>

                                <a class="totAmount"><b>Total  Send Amount : <?php echo $summary_array["SendAmount"]; ?></b></a>
                                <a class="totAmount"><b>Total Charge : <?php echo $summary_array["ServiceCharge"]; ?></b></a>
                                <a class="totAmount"><b>Total Amount : <?php echo $summary_array["PayAmount"]; ?></b></a>
                                                ...
                                                <form class="form-group mg-t-0">
                                                    <div id="dateragne-picker21">
                                                        <div class="input-daterange input-group">
                                                            <input  autocomplete="off" class="form-control" id="FromDate" name="FromDate" placeholder="From Date" required="required" type="text" value="<?php echo $from; ?>" />
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                            <input  autocomplete="off" class="form-control" id="ToDate" name="ToDate" placeholder="To Date" required="required" type="text" value="<?php echo $to; ?>" />
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
foreach($result_all->result() as $result) {
    ...
    ?>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters" class="ng-scope">
                                                        ...
                                                        <td class="ng-binding"><?php echo $result->SenderName; ?></td>
                                                        <td class="ng-binding"><?php echo $result->ReceiverName; ?></td>
                                                        <td class="ng-binding"><?php echo $result->PaymentMode; ?></td>
                                                        <td class="ng-binding"><?php echo round($result->SendAmount,2); ?></td>
                                                        <td class="ng-binding"><?php echo round($result->ServiceCharge,2); ?></td>
                                                        <td class="ng-binding"><?php echo round($result->CollectedAmount,2); ?></td>
                                                        <td class="ng-binding"><?php echo round($result->PayAmount,2); ?></td>
                                                        <td style="white-space: nowrap;">
                                                            ...
                                                            <span class="success ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barSuccess"></span><?php echo $result->status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->status == "Pending") {?>
                                                            
                                                            <span class="pending ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barPending"></span><?php echo $result->status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->status == "Failure") {?>
                                                            
                                                            <span class="failure ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barFailure"></span><?php echo $result->status; ?></span>
                                                            <?php } ?>


                                                            <!-- end ngIf: item.TxnStatus==='Success' --><!-- ngIf: item.TxnStatus==='Pending' --><!-- ngIf: item.TxnStatus==='Failure' --><!-- ngIf: item.TxnStatus==='Reversal' -->
                                                        </td>
                                                        <td class="ng-binding"><?php echo $result->add_date; ?></td>
                                                        <td class="ng-binding">
                                                        ...
                                                        <td style="white-space: nowrap;">
                                                            <a href="<?php echo base_url(); ?>Retailer/InTransactionReportDetails?Id=<?php echo $result->Id; ?>" target="_blank" class="btnview"><i class="fa fa-eye"></i> More</a>
...
<?php
        ...
        $total_amount=$result->PayAmount;}
        
$i++;}}else{
   ?>
<tr>
    <td colspan="12" class="bg-danger text-white" style="font-size: 30px;"><center>No Data Found</center></td>
</tr>
