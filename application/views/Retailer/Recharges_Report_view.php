                    ...
                    <div class="col-lg-4 col-9">
                        <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">Recharges History</a></li>
                            </ol>
                        </nav>
                    </div>
...
foreach($result_all->result() as $result) {?>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters" class="ng-scope">
                                                        ...
                                                        <td class="ng-binding"><?php echo $result->recharge_id; ?></td>
                                                        <td class="ng-binding"><?php echo $result->mobile_no; ?></td>
                                                        <td class="ng-binding"><?php echo $result->company_name; ?></td>
                                                        <td class="ng-binding"><?php echo $result->operator_id; ?></td>
                                                        ...
                                                        <td style="white-space: nowrap;">
                                                            ...
                                                            <span class="success ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barSuccess"></span><?php echo $result->recharge_status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->recharge_status == "Pending") {?>
                                                            
                                                            <span class="pending ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barPending"></span><?php echo $result->recharge_status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->recharge_status == "Failure") {?>
                                                            
                                                            <span class="failure ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barFailure"></span><?php echo $result->recharge_status; ?></span>
                                                            <?php } ?>
