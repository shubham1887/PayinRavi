                    ...
                    <div class="col-lg-4 col-9">
                        <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">AEPS History</a></li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <table class="table table-striped table-transaction" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                            <thead>
                                                <tr>
                                                    <th><b>SL</b></th>
                                                    <th><b>date</b></th>
                                                    <th><b>Custmer No.</b></th>
                                                    <th><b>AddharCard No.</b></th>
                                                    <th><b>OPRATOR</b></th>
                                                    <th><b>BALANCE</b></th>
                                                    <th><b>AMOUNT</b></th>
                                                    <th><b>RESPONSE</b></th>
...
foreach($result_all->result() as $result) {?>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters" class="ng-scope">
                                                        ...
                                                        <td class="ng-binding"><?php echo $result->outlet_mobile; ?></td>
                                                        <td class="ng-binding"><?php echo $result->customer_params; ?></td>
                                                        <td class="ng-binding"><?php if($result->sp_key == 'BAP'){
                                                                echo "Balance Enquiry";
                                                            
                                                            }
                                                            elseif($result->sp_key == 'WAP'){
                                                                echo "Cash Withdrawal ";
                                                            } ?></td>
                                                        <td class="ng-binding"><?php echo $result->balance; ?></td>
                                                        <td class="ng-binding"><?php echo $result->amount; ?></td>
                                                        <td class="ng-binding"><?php echo $result->response_msg; ?></td>
                                                        <td class="ng-binding"><?php echo $result->request_id; ?></td>
                                                        <td class="ng-binding">
                                                       
                                                            <?php if($result->cb_status == "SUCCESS") {?>
                                                            
                                                            <span class="success ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barSuccess"></span><?php echo $result->cb_status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->cb_status == "PENDING") {?>
                                                            
                                                            <span class="pending ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barPending"></span><?php echo $result->cb_status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->cb_status == "FAILED") {?>
                                                            
                                                            <span class="failure ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barFailure"></span><?php echo $result->cb_status; ?></span>
                                                            <?php } ?></td>
