                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <td><b>Amount</b></td>
                                            <td>
                                                <input type="text" name="txtConfAmount" id="txtConfAmount" value="{{shopayamount}}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Due Date</b></td>
...
<!--Textbox Search End-->
        ...
        <form id="printbillreceipt" action="<?php echo base_url(); ?>Retailer/Print_bill_online_copy/retailerprint" method="get" target="_blank">
            <input type="hidden" id="printbilid" name="id">
        </form>
        <script type="text/javascript">
            function billprint(id)
            {
                document.getElementById("printbilid").value = id;
                document.getElementById("printbillreceipt").submit();
            }
        </script>
        <!--Modal End-->
