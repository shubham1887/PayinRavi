...
<div data-ng-app="myapp">
    <div data-ng-controller="RGMainctrl">
                    ...
                    <div class="row align-items-center py-3">
                        <div class="col-lg-4 col-9">
                            <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Wallet1 Statement Report</a></li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-lg-8 col-3 text-right">
                            <div class="page-header">                              
                                    ...
                                    <div class="card-action pull-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item success"><b>Total Credit Amount : {{alltransaction.Success}}</b></a>
                                ...
                                <div class="ml-auto">                                    
                                        <a class="success"><b> Total Credit : {{alltransaction.Success}}</b></a>
                        ...
                        <div class="card-content">
                            <div class="card-body pd-xs-10">
                                <div class="row">
                                        ...
                                        <form class="form-group mg-t-0">
                                            <div id="dateragne-picker21">
                                                <div class="input-daterange input-group">
                                                    <input type="text" class="form-control" id="Fromdate" name="Fromdate" placeholder="Select From Date" autocomplete="off" />
                                    ...
                                    <div class="col-md-2 col-2 col-lg-2 col-sm-2 pd-xs-l-0">
                                    ...
                                    <div class="col-md-2 col-2 col-lg-3 col-sm-2 pull-xs-r pd-xs-r-0">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary pull-right" title="Select date and export all transaction" data-ng-click="DotransactionEw1Export()"><span class="fa fa-file-excel-o"></span></button>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-10 col-lg-3 col-sm-3">
                                        <div class="form-group">
                                                ...
                                                <tbody>
                                                   <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters">
                                                        ...
                                                        <td style="white-space: nowrap;">
                                                            <span class="success" data-ng-if="item.TxnStatus==='CRADIT'"><span class="barSuccess"></span>{{item.TxnStatus}}</span>
                                                            <span class="success" data-ng-if="item.TxnStatus==='Success'"><span class="barSuccess"></span>Successful</span>
                                                            <span class="pending" data-ng-if="item.TxnStatus==='DEBIT'"><span class="barPending"></span>{{item.TxnStatus}}</span><span class="failure" data-ng-if="item.TxnStatus==='Failure' "><span class="barFailure"></span>{{item.TxnStatus}}</span>
                                                            <span class="reversal" data-ng-if="item.TxnStatus==='Recharge_Refund'"><span class="barFailure"></span>Reversal</span>
                                                            <span class="reversal" data-ng-if="item.TxnStatus==='PAYMENT'"><span class="barReversal"></span>{{item.TxnStatus}}</span>
                                                        </td>
                                                    </tr>
