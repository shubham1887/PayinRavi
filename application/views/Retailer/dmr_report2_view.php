                ...
                <div class="row align-items-center py-3">
                    ...
                    <div class="col-lg-8 col-3 text-right">
                        <div class="page-header">
                                ...
                                <div class="card-action pull-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item success"><b>Total Amount Success : <?php echo $summary_array["Success"]; ?></b></a>
                                            <a class="dropdown-item failure" ><b>Total Amount Failure : <?php echo $summary_array["Failure"]; ?></b></a>
                                            <a class="dropdown-item pending"><b>Total Amount Pending : <?php echo $summary_array["Pending"]; ?></b></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="ml-auto">
                                <a class="success"><b>Total Amount Success : <?php echo $summary_array["Success"]; ?></b></a>
                                <a class="failure" ><b>Total Amount Failure : <?php echo $summary_array["Failure"]; ?></b></a>
                                <a class="pending"><b>Total Amount Pending : <?php echo $summary_array["Pending"]; ?></b></a>
                            </div>
                        </div>
                    </div>
                </div>
...
foreach($result_all->result() as $result) {?>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters" class="ng-scope">
                                                        ...
                                                        <td class="ng-binding"><?php echo $result->RemiterMobile; ?></td>
                                                        <td class="ng-binding"><?php echo $result->RESP_name; ?></td>
                                                        <td class="ng-binding"><?php echo $result->AccountNumber; ?></td>
                                                        <td class="ng-binding"><?php echo $result->IFSC; ?></td>
                                                        <td class="ng-binding"><?php echo $result->mode; ?></td>
                                                        <td class="ng-binding"><?php echo $result->Amount; ?></td>
                                                        <td class="ng-binding"><?php echo $result->RESP_opr_id; ?></td>
                                                        ...
                                                        <td style="white-space: nowrap;">
                                                            <a href="<?php echo base_url(); ?>Retailer/TransactionReportDetails?Id=<?php echo $result->Id; ?>" target="_blank" class="btnview"><i class="fa fa-eye"></i> More</a>
