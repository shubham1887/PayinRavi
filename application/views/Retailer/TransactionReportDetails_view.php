                                ...
                                <table class="table table-transdet">
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td>Receipt</td>
                                            <td>
                                                <a target="_blank" href="<?php echo base_url(); ?>Retailer/Print_dmr_online_copy?idstr=<?php echo $this->Common_methods->encrypt($dmr_result->row(0)->unique_id); ?>" class="download">View Receipt</a>
