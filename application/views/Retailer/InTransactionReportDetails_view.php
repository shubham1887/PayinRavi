...
<head>
    ...
    <title><?php echo $this->white->getName() ?> | IndoNepal</title>
                ...
                <div class="col-lg-4 col-12">
                    <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="#">IndoNepal Transaction Report Details</a></li>
                        </ol>
                    </nav>
                </div>                
            </div>
                                ...
                                <table class="table" style="border-bottom:1px solid #ddd;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $dmr_result->row(0)->aPinNo; ?></td>
                                            <td><?php echo $dmr_result->row(0)->SendAmount; ?></td>
                                            <td><?php echo $dmr_result->row(0)->ServiceCharge; ?></td>
                                            <td><?php echo $dmr_result->row(0)->CollectedAmount; ?></td>
                                            <td><?php echo $dmr_result->row(0)->PayAmount; ?></td>

                                            <td style="white-space: nowrap;">
                                            <?php if($dmr_result->row(0)->verify_status == "Success") {?>
                                            <span class="success" style="margin-left:0px;"><span class="barSuccess"></span>Success</span>
                                            <?php } ?>
                                            <?php if($dmr_result->row(0)->verify_status == "Failure") {?>
                                ...
                                <table class="table table-transdet">
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>SenderName Mobile</td>
                                                    <td><?php echo $dmr_result->row(0)->SenderName;?></td>
                                                </tr>
                                                <tr>
                                                    <td>Sender Mobile</td>
                                                    <td><?php echo $dmr_result->row(0)->SenderMobile;?></td>
                                                </tr>
                                                <tr>
                                                    <td>Sender Country</td>
                                                    <td><?php echo $dmr_result->row(0)->SenderNationality;?></td>
                                                </tr>
                                                <tr>
                                                    <td>Sender Address</td>
                                                    <td><?php echo $dmr_result->row(0)->SenderAddress;?></td>
                                                </tr>
                                                <tr>
                                                    <td>Sender Id Type</td>
                                                    <td><?php echo $dmr_result->row(0)->SenderIdType;?></td>
                                                </tr>
                                                <tr>
                                                    <td>Sender Id No</td>
                                                    <td><?php echo $dmr_result->row(0)->SenderIdNumber;?></td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td>
                                            ...
                                            <tr>
                                                <td>Receiver Name</td>
                                                <td><?php echo $dmr_result->row(0)->ReceiverName;?></td>
                                            </tr>
                                                <tr>
                                                    <td>Receiver Mobile</td>
                                                    <td><?php echo $dmr_result->row(0)->ReceiverMobile;?></td>
                                                </tr>
                                                <tr>
                                                    <td>Receiver Country</td>
                                                    <td><?php echo $dmr_result->row(0)->PayoutCountry;?></td>
                                                </tr>
                                                <tr>
                                                    <td>Receiver Address</td>
                                                    <td><?php echo $dmr_result->row(0)->ReceiverAddress;?></td>
                                                </tr>
                                    ...
                                    <tr>
                                        <td>MODE</td>
                                        <td><?php echo $dmr_result->row(0)->PaymentMode;?></td>
                                    </tr>
                                    <tr>
                                        <td>Remitance Reason</td>
                                        <td><?php echo $dmr_result->row(0)->RemittanceReason;?></td>
                                    </tr>
                                    <tr>
                                        <td>Relation With Receiver</td>
                                        <td><?php echo $dmr_result->row(0)->Relationship;?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $dmr_result->row(0)->Charge_Amount;?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $clossing_balance;?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td>Receipt</td>
                                            <td>
                                                <a target="_blank" href="<?php echo base_url(); ?>Retailer/Print_in_online_copy?Id=<?php echo $dmr_result->row(0)->Id; ?>" class="download">View Receipt</a>
