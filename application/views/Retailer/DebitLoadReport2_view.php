                        ...
                        <div class="col-lg-4 col-9">
                            <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Wallet2 Debit Report</a></li>
                                </ol>
                            </nav>
                        </div>
...
<script src="<?php echo base_url(); ?>mpayfiles/debitload2_angular.rgpyfncmsr.route.min.1.7.2.js"></script>
<!--Calnedar Plugin-->
