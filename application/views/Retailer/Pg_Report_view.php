                    ...
                    <div class="col-lg-4 col-9">
                        <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">PG History</a></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-8 col-3 text-right">
                        <div class="page-header">
                                ...
                                <div class="card-action pull-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item success"><b>Total Success : <?php echo $summary_array["Success"]; ?></b></a>
                                            <a class="dropdown-item failure" ><b>Total Failure : <?php echo $summary_array["Failure"]; ?></b></a>
                                            <a class="dropdown-item pending"><b>Total Pending : <?php echo $summary_array["Pending"]; ?></b></a>
                            ...
                            <div class="ml-auto">
                                 ...
                                 <a class="success"><b>Total Success : <?php echo $summary_array["Success"]; ?></b></a>
                                <a class="failure" ><b>Total Failure : <?php echo $summary_array["Failure"]; ?></b></a>
                                <a class="pending"><b>Total Pending : <?php echo $summary_array["Pending"]; ?></b></a>
...
foreach($result_all->result() as $result) {?>
                                                    <tr data-ng-repeat="item in alltransaction.Data | filter:myfilters" class="ng-scope">
                                                        ...
                                                        <td class="ng-binding"><?php echo $result->mobile_no; ?></td>
                                                        <td class="ng-binding"><?php echo $result->payment_group; ?></td>
                                                        <td class="ng-binding"><?php echo $result->cf_payment_id; ?></td>
                                                        <td class="ng-binding"><?php echo $result->bank_reference; ?></td>
                                                      
                                                        <td class="ng-binding"><?php echo $result->order_amount; ?></td>
                                                       
                                                        <td style="white-space: nowrap;">
                                                            <!-- ngIf: item.TxnStatus==='Success' -->


                                                            <?php if($result->payment_status == "SUCCESS") {?>
                                                            
                                                            <span class="success ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barSuccess"></span><?php echo $result->payment_status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->payment_status == "Pending") {?>
                                                            
                                                            <span class="pending ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barPending"></span><?php echo $result->payment_status; ?></span>
                                                            <?php } ?>


                                                            <?php if($result->payment_status == "Failure") {?>
                                                            
                                                            <span class="failure ng-binding ng-scope" data-ng-if="item.TxnStatus==='Success'"><span class="barFailure"></span><?php echo $result->payment_status; ?></span>
                                                            <?php } ?>
...
<?php
        ...
        $total_amount  +=  $result->order_amount;}
        $i++;}}else{
   ?>
<tr>
