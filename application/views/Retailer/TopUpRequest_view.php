                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo base_url(); ?>Retailer/TopUpRequest" method="post" enctype="multipart/form-data" autocomplete="off">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        jQuery('#RequesttoUser').change(function () 
        {
            ...
            if (userName !== '') {
                jQuery.post('<?php echo base_url(); ?>/Retailer/TopUpRequest/TopUpRequestBanks', { requestUser: userName }, function (response) {
                    if (response !== '') {
