...
<!--Page Styles-->
<link href="<?php echo base_url(); ?>mpayfiles/certificate/mystyle.css" rel="stylesheet" />
<link href="<?php echo base_url(); ?>mpayfiles/certificate/certificate.css" rel="stylesheet" />
<link href="<?php echo base_url(); ?>mpayfiles/certificate/certificatePrint.css" rel="stylesheet" media="print" />
<link href="https://fonts.googleapis.com/css?family=Great+Vibes|Libre+Barcode+39" rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Great+Vibes|Libre+Barcode+39|Satisfy|Tangerine" rel="stylesheet">
                                ...
                                <div class="col-md-12 pd-x-0">
                                    <div id="dvContents">
                                        <div class="col-xl-10 text-right">
                                            <a class="print" href="#" id="btnPrint">Print</a>
                                        </div>
                                        <div class="col-lg-2 col-xl-2"></div>
                                        <div class="col-md-12 col-lg-12 col-xl-8 mx-auto text-center pd-x-0">
                                            <div class="main1">
                                                <img src="<?php echo base_url(); ?>mpayfiles/certificate/Certificate-small.jpg" class="img-fluid" style="margin-top: 0px;z-index:1;" id="screen">
                                                <img src="<?php echo base_url(); ?>mpayfiles/certificate/Certificate-small.jpg" class="img-fluid" style="margin-top: 0px;z-index:1;display:none;" id="print">
                                                <div class="divtext">
                                                    <div class="divtext">
                                                        Certificate No.: RT<?php echo $this->session->userdata("AgentId"); ?>
                                                    </div>
                                                </div>
                                                
                                                <div class="clogo">
                                                  
                                                    <img src="<?php echo base_url(); ?>payin_logo.png" class="img-fluid"  width="100" height="100"  style="margin-top: 0px;z-index:2;
                                                    " />
                                                </div>
                                                <div class="divtext1">
                                                    <?php echo $this->session->userdata("AgentBusinessName"); ?>
                                                </div>
                                                <div class="divtext2">
                                                    <?php echo $this->session->userdata("AgentBusinessName"); ?>
                                                </div>
                                                <div class="divtext3">
                                                    <?php echo $myinfo->row(0)->add_date; ?>
                                                </div>

                                                <div class="sign">
                                                    <img src="<?php echo base_url(); ?>mpayfiles/certificate/sign.png" class="mysign" />
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $(function () {
        $("#btnPrint").click(function () {
            ...
            frameDoc.document.write('<html><head><title>Authorization Certificate</title>');
            frameDoc.document.write('</head><body>');
            //Append the external CSS file.
            frameDoc.document.write('<link href="../../Content/Css/bootstrap.min.css" rel="stylesheet" media="print" />');
            frameDoc.document.write('<link href="../../Content/Css/Certificate/mystyle.css" rel="stylesheet"  media="print" />');
            frameDoc.document.write('<link href = "../../Content/Css/Certificate/certificatePrint.css" rel = "stylesheet" media="print" />');
