                                        ...
                                        foreach($mycomm->result() as $rwmycom)
                                        {
                                         ...
                                         ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $rwmycom->service_name; ?>
                                                            </td>

                                                            <td>
                                                                <?php echo $rwmycom->commission; ?> <?php if($rwmycom->commission_type == "PER"){ ?><b class="text-red">%</b><?php }?>
                                                            </td>
                                                            <td>
                                                                <b class="text-orange">&#8377;</b> 0.00
                                                            </td>
                                                            <td>
                                                                0.00 <b class="text-red">%</b>
                                                            </td>
                                                            <td>
                                                                <b class="text-orange">&#8377;</b>  0.00
                                                            </td>
