        ...
        <div id="global">
	        <div class="container-fluid">
               <div class="panel panel-default">
                            <div class="panel-heading">LEDGER File Upload</div>
                            <div class="panel-body">
                            <form action="<?php echo base_url()."Admin/ledgeruploadfile" ?>" method="post" name="frmCallAction" id="frmCallAction" enctype="multipart/form-data">
