...
<html lang="en">
    <head>
		...
		$('document').ready(function(){
		  ...
		  document.getElementById("ddldebtcrdexp").value = '<?php echo $debtcrd_type.'_'.$ddldebtcrdexp_id; ?>';
                                    ...
                                    function startexoprt()
{
		...
		document.getElementById("frmexport").submit();
                                ...
                                <form id="frmexport" name="frmexport" action="<?php echo base_url()."Admin/filter_bank_ledger_datewise/dataexport" ?>" method="get">
								...
								$i=1;
                                    ...
                                    <tr class="<?php echo $class; ?>">
                                           <td>
                                            ...
                                            <td><span id="span_balance_<?php echo $row->Id; ?>"><?php echo $row->group_widdep_list; ?></span></td>
