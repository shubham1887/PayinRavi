        ...
        <div id="global">
	        <div class="container-fluid">
               <div class="panel panel-default">
                            <div class="panel-heading">User Detail File Upload</div>
                            <div class="panel-body">
                            <form action="<?php echo base_url()."royal1718/UserDetailUpload" ?>" method="post" name="frmCallAction" id="frmCallAction" enctype="multipart/form-data">
