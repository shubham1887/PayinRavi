                            ...
                            <div class="panel-body">
								...
								$i=1;
                                    ...
                                    <tr class="<?php echo $class; ?>">
                                            ...
                                            <td id="tdremark_<?php echo $row->Id; ?>"><?php echo $row->accountName; ?></td>
                                             <td id="transaction_date_<?php echo $row->Id; ?>"><?php echo date_format(date_create($row->transaction_date),'Y-m-d'); ?></td>
                                    	    ...
                                    	    <td id="Id_<?php echo $row->Id; ?>"><?php echo $row->Id; ?></th>
                                           
                                            <td id="Withdrawal_<?php echo $row->Id; ?>"><?php echo $row->Withdrawal; ?></td>
                                            <td id="Deposit_<?php echo $row->Id; ?>"><?php echo $row->Deposit; ?></td>
                                            <td id="Balance_<?php echo $row->Id; ?>"><?php echo $row->Balance; ?></td>
                                            <td id="Narration_<?php echo $row->Id; ?>"><?php echo $row->Narration; ?></td>
