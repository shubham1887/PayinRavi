                                    ...
                                    <tr class="<?php echo $class; ?>">
                                            ...
                                            <td id="Withdrawal_<?php echo $row->Id; ?>"><?php echo $row->totaldebit; ?></td>
                                             <td id="Withdrawal_<?php echo $row->Id; ?>"><?php echo $row->totaldeposit; ?></td>
                                              <td id="Withdrawal_<?php echo $row->Id; ?>"><?php echo $row->totaldeposit_reverse; ?></td>
                                             <td id="Withdrawal_<?php echo $row->Id; ?>"><?php echo (($row->totaldeposit - $row->totaldeposit_reverse -  ($row->totalcredit - $row->totaldebit - $row->opening_outstanding))); ?></td>
