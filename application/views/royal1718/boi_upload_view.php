        ...
        <div id="global">
	        <div class="container-fluid">
               <div class="panel panel-default">
                            <div class="panel-heading">BOI SHEET UPLOAD</div>
                            <div class="panel-body">
                            <form action="<?php echo base_url()."Admin/boi_upload" ?>" method="post" name="frmCallAction" id="frmCallAction" enctype="multipart/form-data">
