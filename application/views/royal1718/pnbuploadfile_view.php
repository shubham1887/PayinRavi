        ...
        <div id="global">
	        <div class="container-fluid">
               <div class="panel panel-default">
                            <div class="panel-heading">PNB SHEET UPLOAD</div>
                            <div class="panel-body">
                            <form action="<?php echo base_url()."Admin/pnbuploadfile" ?>" method="post" name="frmCallAction" id="frmCallAction" enctype="multipart/form-data">
