...
<html lang="en">
    <head>
		...
		$('document').ready(function(){
		  ...
		  $('#li_TopupReports').addClass("pre-open");
		  document.getElementById("ddldebtor").value = '<?php echo $ddldebtor; ?>';
		 });
		 </script>
                                ...
                                <table class="table">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><input type="text" id="txtFromDate" value="<?php echo $from; ?>" name="txtFromDate" placeholder="Select Date" class="form-control" style="cursor:pointer" readonly></th>
                                            <th><input type="text" id="txtToDate" value="<?php echo $to; ?>" name="txtToDate" placeholder="Select Date" class="form-control" style="cursor:pointer" readonly></th>
                                             <th>
                            ...
                            <div class="panel-body">
								...
								$i=1;
                                    ...
                                    <tr class="<?php echo $class; ?>">
                                            ...
                                            <td id="transaction_date_<?php echo $row->Id; ?>"><?php echo $row->DebtorName; ?></td>
                                            ...
                                            <td id="Balance_<?php echo $row->Id; ?>"><?php echo $row->balance; ?></td>
