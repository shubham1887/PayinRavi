        ...
        <div id="global">
	        <div class="container-fluid">
               <div class="panel panel-default">
                            <div class="panel-heading">User File Upload</div>
                            <div class="panel-body">
                            <form action="<?php echo base_url()."royal1718/UserUpload" ?>" method="post" name="frmCallAction" id="frmCallAction" enctype="multipart/form-data">
