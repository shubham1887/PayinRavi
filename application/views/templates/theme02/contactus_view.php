          		...
          		<div class="col-md-6">
					...
					<div class="contact-info">
						<div class="col-md-12">
							...
							<p><?php echo $data["OfficeAddress"] ?></p>
						</div>
						<div class="col-md-6">
							<h5> <i class="fa fa-phone"></i> &nbsp;Call Us</h5>
							<p>(91) <strong><?php echo $data["SalesTeamContact"] ?></strong></p>
							<p>(91) <strong><?php echo $data["CustomerCare"] ?></strong></p>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<p><a href="mailto:info@rechargeunlimited.com"><?php echo $data["EmailId"] ?></a></p>
						</div>
					</div>
				</div>
			</div>
