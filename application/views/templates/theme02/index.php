<?php include("template_assets/theme02/header.php"); ?>
	<section class="home-slider">
    	<div class="tp-banner-container">
      		<div class="tp-banner-fix">
        		<ul>		
          			<li data-transition="fade" data-slotamount="7" style="background:#999900">
		  			<img src="../../template_assets/theme02/images/slide-bg-1.jpg" data-bgposition="center top" alt="" />            
					<!-- Layer -->
					<div class="tp-caption sft tp-resizeme font-extra-bold" 
						  ...
						  data-endspeed="300" 
						  data-captionhidden="on"> <img src="../../template_assets/theme02/images/operator-1.png" alt="" > </div>
					...
					<img src="../../template_assets/theme02/images/slide-bg-2.jpg" data-bgposition="center top" alt="" /> 
					<div class="tp-caption sft tp-resizeme font-extra-bold" 
						  ...
						  data-endspeed="300" 
						  data-captionhidden="on" 
						  > <img src="../../template_assets/theme02/images/bus-1.png" alt="" > </div>
					<div class="tp-caption sfb tp-resizeme font-bold" 
  ...
  <div id="content">
    ...
    <section class="light-gray-bg solution padding-top-50 padding-bottom-50">
      	<div class="container"> 
        	<div class="heading-block text-center margin-bottom-80">
          		<h3>Welcome To <?php echo $data["company_name"]; ?></h3>
        	...
        	<ul class="row text-center">
				<li class="col-xs-6 col-md-3"> <img src="../../template_assets/theme02/images/bus-icon.png" alt="">
            	<h6>BUS TICKETING</h6>
				</li>
				<li class="col-xs-6 col-md-3"> <img src="../../template_assets/theme02/images/phone-icon.png" alt="">
				<h6>MOBILE RECHARGE</h6>
				</li>
				<li class="col-xs-6 col-md-3"> <img src="../../template_assets/theme02/images/dish-icon.png" alt="">
				<h6>DTH RECHARGE</h6>
				</li>
				<li class="col-xs-6 col-md-3"> <img src="../../template_assets/theme02/images/bill-icon.png" alt="">
    ...
    <section class="front-page padding-top-50 padding-bottom-50" style="background:#028fc9;">
      	<div class="container">
        	<div class="row">
          		<div class="col-md-6 text-center"> <img class="img-responsive margin-top-10" src="../../template_assets/theme02/images/operator-1.png" alt=" "> </div>
          		<div class="col-md-6">
    ...
    <section class="clients padding-top-50 padding-bottom-50">
      	<div class="container"> 
        	...
        	<div class="row">
                ...
                <div class="col-md-2"> <img src="../../template_assets/theme02/images/avatar-2.png" alt=""> </div>
			</div>
        </div>
      </div>
    </section>  
  ...
  <!-- End Content --> 
<?php include("template_assets/theme02/footer.php"); ?>