    ...
    <section class="padding-top-30 padding-bottom-100">
      	<div class="container"> 
        	<div class="heading-block text-center margin-bottom-30">
				<p>We are providing online <strong>FREE</strong> registration. So there is no need to visit retail shop or pay anyone to recharge your mobile phone. All you need to do is register yourself on <strong><?php echo base_url(); ?></strong> with correct information. </p>
			</div>
			<div class="col-md-12">
