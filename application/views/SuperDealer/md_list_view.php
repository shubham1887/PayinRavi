            ...
            <div class="row row-sm mg-t-20">
                    ...
                    <div class="card shadow-base bd-0">
                      ...
                      <div class="card-body">
                                          ...
                                          <form action="<?php echo base_url()."SuperDealer/md_list?crypt=".$this->Common_methods->encrypt("MyData") ?>" method="post" name="frmCallAction" id="frmCallAction">
                           <input type="hidden" id="hidID" name="hidID">
                                    <table cellspacing="10" cellpadding="3">
                                    <tr>
                                      <td style="padding-right:10px;">
                                        <div class="form-group">
                                            <h5 for="example-date-input" class="col-form-label">Md.Dist. Name</h5>
                                          <input class="form-control-sm datepicker" type="text" value="<?php echo $txtAGENTName; ?>"  id="txtAGENTName" name="txtAGENTName"  placeholder="MasterDealer Name" >    
                                      </div>
                                          
                                        </td>
                                        <td style="padding-right:10px;">
                                        <div class="form-group">
                                            <h5 for="example-date-input" class="col-form-label">Md.Dist. ID</h5>
                                            <input class="form-control-sm" id="txtAGENTId" value="<?php echo $txtAGENTId; ?>" name="txtAGENTId" type="text"  placeholder="MasterDealer USER ID">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <input class="form-control-sm" id="txtMOBILENo" value="<?php echo $txtMOBILENo; ?>" name="txtMOBILENo" type="text"  placeholder="MasterDealer MOBILE NO">
             ...
             <div class="row row-sm mg-t-20">
                    ...
                    <div class="card shadow-base bd-0">
                      ...
                      <span class="tx-12 tx-uppercase">
                        <a href="<?php echo base_url()."SuperDealer/Md_registration" ?>"  class="blue btn btn-primary btn-sm" > <i class="ace-icon fa fa-plus bigger-120"></i>Add New User </a>
...
<td ><a href="<?php echo base_url()."SuperDealer/profile?usertype=".$this->Common_methods->encrypt("MasterDealer")."&user_id=".$this->Common_methods->encrypt($result->user_id);?>" target="_blank"><?php 
...
?></a></td>
<td ><a href="<?php echo base_url()."SuperDealer/profile/view/".$this->Common_methods->encrypt("MasterDealer")."/".$this->Common_methods->encrypt($result->parentid);?>" target="_blank"><?php echo $result->parent_name; ?></a></td>
...
<?php
 ...
 <td width="180px">
  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."SuperDealer/md_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
