...
<html lang="en">
  <head>
        <title>Master Distributor Registration</title>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="card shadow-base bd-0">
                        <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                                            <h6 class="card-title tx-uppercase tx-12 mg-b-0">Master Distributor Registration Form</h6>
                        ...
                        <div class="card-body">
                                ...
                                <form method="post" action="<?php echo base_url()."SuperDealer/md_registration"?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">  
