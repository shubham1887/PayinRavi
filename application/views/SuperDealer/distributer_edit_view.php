            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h5 class="text-themecolor m-b-0 m-t-0">Distributor Edit</h5>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                           ...
                           <form method="post" action="<?php echo base_url()."SuperDealer/distributer_edit?crypt=".$this->Common_methods->encrypt("MyData");?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
...
<tbody>
  <tr>
    <td><h5>Scheme :</h5><select style="width:300px;" class="form-control-sm" id="ddlSchDesc" onChange="ChangeAmount()" placeholder="Select Scheme Name.<br />Click on drop down" name="ddlSchDesc">
      ...
      <?php
$str_query = "select * from tblgroup where groupfor = 'Distributor' or groupfor = 'ALL'";
