            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                      <h4 class="text-themecolor m-b-0 m-t-0">FOS LIST</h4>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <form action="<?php echo base_url()."SuperDealer/fos_list?crypt=".$this->Common_methods->encrypt("MyData") ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<td ><a href="<?php echo base_url()."SuperDealer/profile?usertype=".$this->Common_methods->encrypt("FOS")."&user_id=".$this->Common_methods->encrypt($result->user_id);?>" target="_blank">
<?php 
    echo $result->businessname;     
?></a></td>
<td ><a href="<?php echo base_url()."SuperDealer/profile?usertype=".$this->Common_methods->encrypt("FOS")."&user_id=".$this->Common_methods->encrypt($result->parentid);?>" target="_blank"><?php echo $result->parent_name; ?></a></td>
...
<td>
 ...
 <td width="180px">
<!--  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."SuperDealer/fos_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       -->
<a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."SuperDealer/fos_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
   |       
 <?php 
                                        ...
                                        function Confirmation(value)
	{
		...
		if(confirm("Are you sure?\nyou want to delete ") == true)
		{
			...
			document.getElementById('frmDelete').submit();
                                      ...
                                      <form action="<?php echo base_url()."SuperDealer/distributor_list?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" autocomplete="off" name="frmDelete" id="frmDelete">
