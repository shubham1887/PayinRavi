...
<div id="loadingGIF"><img style="width:100px;" src="<?PHP echo base_url(); ?>Loading.gif" /></div>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  ...
                  <form action="<?php echo base_url()."SuperDealer/dmr_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmReport" id="frmReport">
       ...
       <form id="frmexport" name="frmexport" action="<?php echo base_url()."SuperDealer/dmr_report/dataexport" ?>" method="get">
