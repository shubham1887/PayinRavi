...
<script language="javascript">
  function wait(ms){
   ...
   while(end < start + ms) {
    ...
    function getnotifications()
    {
        $.ajax({
        type: "GET",
        url: '<?php echo base_url(); ?>SuperDealer/dashboard/gettotalnotification',
        cache: false,
        success: function(html)
        {
          
          $("#callmespan").html(html);
        },
        complete:function()
        {
  ...
  function get_operatorrouting()
  {
    ...
    $.ajax({
        type: "GET",
        url: '<?php echo base_url(); ?>SuperDealer/dashboard/getbirthdate',
        cache: false,
        success: function(html)
        {
    ...
    function get_SuccessRecharge()
    {
       ...
       $.ajax({
        type: "GET",
        url: '<?php echo base_url(); ?>SuperDealer/dashboard/getTotalSuccessRecahrge',
        cache: false,
        success: function(html)
        {
    ...
    function get_DMRValues()
    {
       ...
       $("#valdmrfailure").html("");
       $("#valdmrpending").html("");
       document.getElementById("spindmrsuccess").style.display="block";
       document.getElementById("icondmrsuccess").style.display="none";
       document.getElementById("spindmrfailure").style.display="block";
       document.getElementById("icondmrfailure").style.display="none";
       document.getElementById("spindmrpending").style.display="block";
       document.getElementById("icondmrpending").style.display="none";
       $.ajax({
        type: "GET",
        url: '<?php echo base_url(); ?>SuperDealer/dashboard/getTotalDMRValues',
        cache: false,
        success: function(html)
        {
          var jsonobj = JSON.parse(html);
          ...
          $("#valdmrsuccess").html(Success+"  |  "+SuccessCount);
          $("#valdmrfailure").html(Failure+"  |  "+FailureCount);
          $("#valdmrpending").html(Pending+"  |  "+PendingCount);
        ...
        complete:function()
        {
          document.getElementById("icondmrsuccess").style.display="block";
          document.getElementById("spindmrsuccess").style.display="none";
          document.getElementById("icondmrfailure").style.display="block";
          document.getElementById("spindmrfailure").style.display="none";
          document.getElementById("icondmrpending").style.display="block";
          document.getElementById("spindmrpending").style.display="none";
        }
      });
          ...
          function get_load()
            {
              ...
              ({
                      type: "GET",
                      url: '<?php echo base_url(); ?>SuperDealer/dashboard/getLoad',
                      cache: false,
                      success: function(html)
                      {
            ...
            function get_load2()
            {
              ...
              ({
                      type: "GET",
                      url: '<?php echo base_url(); ?>SuperDealer/dashboard/getLoad2',
                      cache: false,
                      success: function(html)
                      {
                          document.getElementById("userbalance2div").innerHTML = html;
                              }
    ...
    <div class="br-mainpanel">
          ...
          <div class="col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-footer tx-12 pd-y-15 bg-transparent">
                ...
                <a href="<?php echo base_url()."SuperDealer/Dmr_report?crypt=".$this->Common_methods->getAgentBalance($this->session->userdata("ApiId")); ?>"><i class="fa fa-angle-down mg-r-5"></i>View All Transaction History</a>
      ...
      <footer class="br-footer">
        ...
        <div class="footer-right d-flex align-items-center">
          ...
          <a target="_blank" class="pd-x-5" href="javascript:void(0)"></i></a>

          <a target="_blank" class="pd-x-5" href="javascript:void(0)"><i class="fab fa-twitter tx-20"></i></a>
    ...
    <script src="<?php echo base_url(); ?>js/widgets.js"></script>
...

        {
            ...
            $.ajax({
                    ...
                    url: '<?php echo base_url(); ?>SuperDealer/Dashboard/getSummary',
...

        {
            ...
            $.ajax({
                    ...
                    url: '<?php echo base_url(); ?>SuperDealer/Dashboard/getLastTransactions',
