...
<html lang="en">
  <head>
    ...
    <title>SuperDealer Information</title>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">SuperDealer INFORMATION</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="br-pagetitle">
        <div>
          <h4>SuperDealer INFORMATION 1</h4>
        </div>
      </div><!-- d-flex -->
        ...
        <div class="row row-sm mg-t-20">
          <div class="col-sm-6 col-lg-12">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form role="form" method="post" action="<?php echo base_url()."SuperDealer/admininfo" ?>">
