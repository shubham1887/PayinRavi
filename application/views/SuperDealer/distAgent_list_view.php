            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                      <h4 class="text-themecolor m-b-0 m-t-0">Retailer LIST</h4>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <form action="<?php echo base_url()."SuperDealer/distAgent_list?crypt=".$this->Common_methods->encrypt("MyData") ?>" method="post" name="frmCallAction" id="frmCallAction">
...
?></a></td>
<td ><a href="<?php echo base_url()."SuperDealer/profile?usertype=".$this->Common_methods->encrypt("MasterDealer")."&user_id=".$this->Common_methods->encrypt($result->parentid);?>" target="_blank"><?php echo $result->parent_name; ?></a></td>
...
<td class="padding_left_10px box_border_bottom box_border_right" align="left" height="34">
 <?php echo $result->dmr_group; ?>
 </td>			
			
<!-- end dmr group td -->
			
<td style="width:140px;min-width:140px;">
<span id="spanbalance<?php echo $result->user_id; ?>">
	<?php 
	$totalload += $result->balance;
	echo $result->balance; ?>
</span>
</td>
<td>
		    ...
		    <th><b><?php echo $totalload; ?></b></th>
                                      ...
                                      { 	
                                          ...
                                          document.getElementById("frmstatuschange").submit(); 
                                       	...
                                       	<form id="frmstatuschange" action="<?php echo base_url()."SuperDealer/md_list"; ?>" method="post"> 
