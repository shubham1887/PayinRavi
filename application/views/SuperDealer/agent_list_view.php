          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  ...
                  <form action="<?php echo base_url()."SuperDealer/agent_list?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">                            
...
<td ><a href="<?php echo base_url()."SuperDealer/profile/view/".$this->Common_methods->encrypt("Agent")."/".$this->Common_methods->encrypt($result->user_id);?>" target="_blank"><?php 
...
<?php if($result->status == 0){echo "<span class='red'>Deactive</span>";}else{echo "<span class='green'><a href='#' onclick='actionDeactivate(".$result->user_id.",0)'>Active</a></span>";} ?>
 ...
 <td width="180px">
  ...
  <a class="far fa-edit" style="font-size:18px;" href="<?php echo base_url()."SuperDealer/agent_edit?id=".$this->Common_methods->encrypt($result->user_id); ?>" title="Edit Franchise"></a> 
...

 {
    ...
    url:'<?php echo base_url()."SuperDealer/agent_list/minRechargeLimit";?>?minrechargelimit='+minrechargelimit+'&id='+user_id,
...

{
    ...
    url:'<?php echo base_url()."SuperDealer/agent_list/changedmrgroup?id=";?>'+id+'&field='+myval,
...

{
 ...
 <input type="hidden" id="hidurltoggle" value="<?php echo base_url()."SuperDealer/agent_list/togglegroup"; ?>">
...

        {
            ...
            {      
                ...
                url:'<?php echo base_url()."SuperDealer/agent_list/setvalues?"; ?>Id='+id+'&field=MT&val=1',
...

            {
                ...
                url:'<?php echo base_url()."SuperDealer/agent_list/setvalues?"; ?>Id='+id+'&field=MT&val=0',
