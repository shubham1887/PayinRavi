...
<head>
   ...
   <!-- Favicon icon -->
    ...
    <title>Downline Account Report</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h4 class="text-themecolor m-b-0 m-t-0">DOWNLINE ACCOUNT REPORT</h4>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form action="<?php echo base_url()."SuperDealer/agent_account_report?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">
                                    ...
                                    <td style="padding-right:10px;">
                                        	 <h5>Mobile Number</h5>
                                            <input class="form-control-sm" value="<?php echo $username; ?>" id="txtUserId" name="txtUserId" type="text" style="width:120px;" placeholder="Enter Mobile Number">
                                        </td>
                                        <td style="padding-right:10px;">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">DOWNLINE ACCOUNT REPORT</h4>
                                <div class="table-responsive">
