        ...
        <div class="row row-sm mg-t-20">
          <div class="col-sm-14 col-lg-14">
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  <form action="<?php echo base_url()."SuperDealer/recharge_history?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmsubmit" id="frmsubmit">
                    ...
                    <td style="padding-right:10px;">
                         ...
                         <option value="ARCHIVE">ARCHIVE</option>
                                    ...
                                    <form action="<?php echo base_url()."SuperDealer/recharge_history?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
 ...
 <?php 
 $totalCommGiven = ($commission_amount + $DComm + $MdComm);
 ...
 <tr id="tr_reqresp<?php echo $result->recharge_id; ?>" style="display:none">
   ...
   <th ><?php echo $totalRecharge; ?></th>    
     ...
     <th></th>  
      ...
      <input type="hidden" id="hidgetlogurl" value="<?php echo base_url()."SuperDealer/getlogs"; ?>">
    <input type="hidden" id="hidgetuserdataurl" value="<?php echo base_url()."SuperDealer/getutils"; ?>">
    
    <!-- Core Scripts - Include with every page -->
   <form id="frmexport" name="frmexport" action="<?php echo base_url()."SuperDealer/recharge_history/dataexport" ?>" method="get">
  ...
  <div class="modal fade" id="myActionModal" role="dialog">
    <div class="modal-dialog"  >
      <div class="modal-content" style="width:600px;">
        ...
        <input type="hidden" id="hidrefundmethodurl" value="<?php echo base_url()."SuperDealer/recharge_history/dorefund"; ?>"> 
        <input type="hidden" id="hidstatusmethodurl" value="<?php echo base_url()."SuperDealer/recharge_history/checkstatus"; ?>"> 
        <input type="hidden" id="hidsuccessmethodurl" value="<?php echo base_url()."SuperDealer/recharge_history/dosuccess"; ?>"> 
        <input type="hidden" id="hidresendtoothermethodurl" value="<?php echo base_url()."SuperDealer/recharge_history/resendtoanotherapi"; ?>"> 
