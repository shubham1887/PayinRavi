          ...
          <div class="col-sm-6 col-lg-12">
            ...
            <div class="card shadow-base bd-0">
              ...
              <div class="card-body">
                  ...
                  <form action="<?php echo base_url()."SuperDealer/accountreport?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">                            
                                    ...
                                    <input class="form-control datepicker" value="<?php echo $from; ?>" id="txtFrom" name="txtFrom" type="text" style="width:120px;cursor:pointer;" readonly placeholder="Select Date">                                         </td>                                       

                                    <td style="padding-right:10px;">                                             

                                    <h5>To Date</h5>                                             

                                    <input class="form-control datepicker" value="<?php echo $to; ?>" id="txtTo" name="txtTo" type="text" style="width:120px;cursor:pointer;" readonly placeholder="Select Date">                                         
...
<form id="frmexport" name="frmexport" action="<?php echo base_url()."SuperDealer/accountreport/dataexport" ?>" method="get">
