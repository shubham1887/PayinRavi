                        ...
                        <div class="d-flex m-t-10 justify-content-end">
                            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                                <div class="chart-text m-r-10">
                                 <button class="btn btn-success" type="button">Total Credit : <?php echo $totalcredit; ?></button>
                            ...
                            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                                <div class="chart-text m-r-10">
                                   <button class="btn btn-warning" type="button">Total Debit : <?php echo $totaldebit; ?></button>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form action="<?php echo base_url()."SuperDealer/topuphistory?crypt=".$this->Common_methods->encrypt("MyData"); ?>" method="post" name="frmCallAction" id="frmCallAction">                            
                                    <input type="hidden" id="hidID" name="hidID">                                     
                                    <table cellspacing="10" cellpadding="3">                                     
                                    <tr>                                     
                                    <td style="padding-right:10px;">                                         	 
                                    <h5>From Date</h5>                                             
                                    <input class="form-control-sm datepicker" value="<?php echo $from_date; ?>" id="txtFrom" name="txtFrom" type="text" style="width:120px;cursor:pointer;" readonly placeholder="Select Date">                                         </td>                                     	
                                    <td style="padding-right:10px;">                                         	 
                                    <h5>To Date</h5>                                             
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                   <table class="table table-striped .table-bordered mytable-border" style="font-size:14px;color:#000000;font-weight:normal;font-family:sans-serif">
                                        ...
                                        $cr_user_id = $result->cr_user_id;
                                            $dr_user_id = $result->dr_user_id;
                                            if(($cr_user_id != 1 ))
                                            {	  ?> 			
                                        <tr class="<?php if($i%2 == 0){echo 'row1';}else{echo 'row2';} ?>"> 
                                        <td><?php echo date_format(date_create($result->payment_date),'d-M-Y H:i:s'); ?></td>  
                                        <td ><?php echo $result->payment_id; ?></td>   <td><?php echo $result->cr_businessname; ?></td>   
