                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="card shadow-base bd-0">
                        ...
                        <div class="card-body">
                                ...
                                <form method="post" action="<?php echo base_url()."SuperDealer/agent_registration"?>" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">  
                                    ...
                                    <tr>
                                     ...
                                     <select id="ddlparent" name="ddlparent" class="form-control-sm" style="width:300px;"> 
                                        ...
                                        <?php   
                                        $rlstparent = $this->db->query("select * from tblusers where usertype_name='Distributor' and host_id = ?",array($this->session->userdata("SdId")));    
                                    ...
                                    <td>
                                        <h5>Scheme :</h5>           
                                            ...
                                            <?php           $str_query = "select * from tblgroup where groupfor = 'Agent'";          
