...
<head>
   ...
   <!-- Favicon icon -->
    ...
    <title>MasterDealer::Payment Request History</title>
    <!-- Bootstrap Core CSS -->
        	...
        	<span id="mobmsg" class="mobmsg"></span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                     <form action="<?php echo base_url()."SuperDealer/paymentreq_history" ?>" method="post" name="frmCallAction" id="frmCallAction">
