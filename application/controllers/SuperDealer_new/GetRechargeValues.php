...
class GetRechargeValues extends CI_Controller {
	...
	{
		return $this->session->userdata("AgentUserName")."#".$this->session->userdata("AgentBusinessName")."#0#".round($this->Common_methods->getAgentBalance($this->session->userdata("SdId")),2)."#".round($this->Ew2->getAgentBalance($this->session->userdata("SdId")),2);
	}
