...
$this->output->set_header("Pragma: no-cache"); 
	...
	//print_r($this->input->post());exit;
		...
		else if($this->input->post('FromDate') and $this->input->post('ToDate'))
		{
			...
			$this->view_data['result_all'] = $this->db->query("SELECT bank.bank_name,a.unique_id,a.Id,a.add_date,a.edit_date,a.user_id,a.DId,a.SdId,a.Charge_type,a.charge_value,a.Charge_Amount,a.RemiterMobile,
...
order by Id desc ",array($user_id,$from,$to));
			...
			$this->load->view('SuperDealer_new/dmr_report2_view',$this->view_data);								
		}
		else 
		{ 						
