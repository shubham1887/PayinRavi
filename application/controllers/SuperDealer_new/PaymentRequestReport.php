...
where a.user_id = ? and Date(a.add_date) BETWEEN ? and ? order by a.Id desc",array($this->session->userdata("SdId"),$from,$to));
			 ...
			 $this->load->view("SuperDealer_new/PaymentRequestReport_view",$this->view_data);
