...
class Dashboard extends My_Controller 
{
	...
	public function index()  
	{
		...
		$this->view_data["message"]  = ""; 
		$this->load->view("SuperDealer_new/Dashboard_view",$this->view_data);
	}

	public function getBalance()
	{
	    echo round($this->Common_methods->getAgentBalance($this->session->userdata("SdId")))."#".round($this->Ew2->getAgentBalance($this->session->userdata("SdId")));
	...
	public function AddressFieldcheck()
	{
		...
		*/
		...
		$rsltuserprofile = $this->db->query("select pancardPath,aadharcardPath,PSAStatus,AadhaarStatus,soapselfiePath,gstcertificatePath,service_agreementPath,AddressProofPath from tblusersprofile where user_id = ?",array($this->session->userdata("SdId")));
