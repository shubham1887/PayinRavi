...
//	$this->db->db_debug = TRUE;
		...
		else
		{
		   // $Id = 12;
		    ...
		    $rslt =$this->db->query("SELECT a.bank_id,bank.bank_name,a.unique_id,a.Id,a.add_date,a.user_id,a.DId,a.SdId,a.Charge_type,a.charge_value,a.Charge_Amount,a.RemiterMobile,
...
left join dezire_banklist bank on a.bank_id = bank.Id
 ...
 //print_r( $rslt->result());exit;
	...
	$this->load->view("SuperDealer_new/print_dmr_online_copy_view",$this->view_data);
