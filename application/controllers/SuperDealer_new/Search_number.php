...
redirect(base_url().'login?crypt='.$this->Common_methods->encrypt("MyData")); 
	...
	//echo "asdfsdf";exit;
		...
		$this->view_data['result_all'] = $this->get_recharge($this->session->userdata("SdId"),$word);
		$this->view_data['message'] =$this->msg;
		$this->load->view('SuperDealer_new/search_number_view',$this->view_data);			
	...
	private function get_recharge($user_id,$word,$ddldb= "LIVE")
	{
		...
		else
		{
			$str_query ="
				...
				b.mobile_no = ?
				order by a.Id desc ";		
				$result = $this->db->query($str_query,array($this->session->userdata("SdId"),$word));
				return $result;
