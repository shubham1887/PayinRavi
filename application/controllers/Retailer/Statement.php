...
class Statement extends CI_Controller {
	...
	//	echo $start_row;exit;
		...
		$this->load->view('Retailer/Statement_view',$this->view_data);			
	}
...
*/
		$str_query ="
				...
				CASE a.transaction_type
				   	WHEN 'Recharge' THEN b.recharge_status
				  	WHEN 'PAYMENT' THEN 'PAYMENT'
				  	WHEN 'Recharge_Refund' THEN 'Recharge_Refund'
				  	WHEN 'CRADIT' THEN 'CRADIT'
