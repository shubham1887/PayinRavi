...
class DebitLoadReport2 extends CI_Controller {
	...
	public function pageview()
	{
		...
		$this->load->view('Retailer/DebitLoadReport2_view',$this->view_data);			
	}
...
/*
		...
		*/
		$str_query ="
				...
				{
					$totalDebit = 0;
					$rsltsummary = $this->db->query("select IFNULL(Sum(a.debit_amount),0) as totalDebit from tblewallet2 a where a.user_id = ? and a.transaction_type = 'PAYMENT' and Date(a.add_date) BETWEEN ? and ?",array($this->session->userdata("AgentId"),$from,$to));
