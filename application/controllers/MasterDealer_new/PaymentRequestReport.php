...
bank.bank_name,
admin_bank_acc.account_name,admin_bank_acc.account_number,admin_bank_acc.ifsc,admin_bank_acc.branch,
...
where a.user_id = ? and Date(a.add_date) BETWEEN ? and ? order by a.Id desc",array($this->session->userdata("MdId"),$from,$to));
			 ...
			 $this->load->view("MasterDealer_new/PaymentRequestReport_view",$this->view_data);
