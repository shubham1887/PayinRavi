...
{
	$id = $_GET["id"];
	$rsltdealer = $this->db->query("select * from tblusers where parentid = ? and usertype_name = 'Distributor'",array($this->session->userdata("MdId")));
	...
	public function index() 
	{
			...
			if(isset($_GET["company_id"]) and isset($_GET["com"]) and isset($_GET["id"]))
			{
					...
					if($parent_id == $this->session->userdata("MdId") and $usertype_name == "Distributor")
					{
