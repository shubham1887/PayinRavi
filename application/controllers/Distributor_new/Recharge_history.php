	...
	//echo "asdfsdf";exit;
		...
		else
		{
            ...
            $rslt_sp = $this->db->query("SELECT 
    						...
    						a.add_date < ?  and a.user_id = ? and a.recharge_status = 'Pending'",array($from,$to,$date,$this->session->userdata("DistId")));
		...
		$this->view_data['result_all'] = $this->get_recharge($from,$to,$this->session->userdata("DistId"),$start_row,$per_page,$word,$ddldb,$ddlstatus,$ddloperator);
		$this->view_data['message'] =$this->msg;
		$this->load->view('Distributor_new/recharge_history_view',$this->view_data);			
