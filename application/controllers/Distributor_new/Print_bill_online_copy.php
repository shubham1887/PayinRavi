...
class Print_bill_online_copy extends CI_Controller {
    ...
    {
		/*if ($this->session->userdata('user_type') != "Distributor" and $this->session->userdata('auser_type') != "Admin") 
		{ 
...
where a.Id = ?",array($Id));
	...
	$this->load->view("Distributor_new/print_bill_online_copy_view",$this->view_data);
