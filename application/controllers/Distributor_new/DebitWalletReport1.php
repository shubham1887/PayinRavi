...
class DebitWalletReport1 extends CI_Controller {
...
redirect(base_url().'login?crypt='.$this->Common_methods->encrypt("MyData")); 
	...
	//	echo $start_row;exit;
		...
		$config['base_url'] = base_url()."Retailer/DebitWalletReport1/pageview";
		...
		$this->load->view('Distributor_new/DebitWalletReport1_view',$this->view_data);			
	}
