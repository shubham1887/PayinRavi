...
class Dashboard extends My_Controller 
{
	...
	public function index()  
	{
		...
		foreach($json_obj->data as $bkarr)	
		{
			...
			$this->view_data["message"]  = ""; 
		$this->load->view("Distributor_new/Dashboard_view",$this->view_data);
	}

	public function getBalance()
	{
	    echo round($this->Common_methods->getAgentBalance($this->session->userdata("DistId")))."#".round($this->Ew2->getAgentBalance($this->session->userdata("DistId")));
