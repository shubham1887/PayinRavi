	  ...
	  // error_reporting(-1);
	   //ini_set("display_errors",1);
		...
		{ 
			...
			$MTDistId = $this->session->userdata("MT_USER_ID");
			$user_id = $this->session->userdata("DistId");
			
			
			if($MTLOGIN == true and $MTDistId == $user_id and strlen($MTSENDERMOBILE) == 10)
			{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
										...
										else if(isset($bene_id) and isset($remitter_id) and isset($transtype) and isset($Amount) and isset($Remark))
										{
											...
											if($checkbeneexist->num_rows() > 0)
											{
												...
												$this->load->view("Distributor_new/dmrmm_cnftransaction_view",$this->view_data);
												...
												$this->load->view("Distributor_new/dmrmm_transaction_view",$this->view_data);
					...
					else
					{
						...
						$this->session->set_userdata("MTDistId","");
						$this->session->set_flashdata("MESSAGEBOX_MESSAGETYPE","FAILURE");
	...
	public function getAccountvalidate()
	{
		...
		$MTDistId = $this->Common_methods->decrypt($this->session->userdata("MTDistId"));
		if(isset($_POST["bid"]))
		{
