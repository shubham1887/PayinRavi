...
class Bene_register extends CI_Controller {
	...
	{ 
		...
		//$remitter_id,$benificiary_name,$benificiary_mobile,$benificiary_ifsc,$benificiary_account_no
			if(isset($_GET['username']) && isset($_GET['password']) && isset($_GET['sendermobile']) && isset($_GET['benificiary_name']) && isset($_GET['benificiary_mobile']) && isset($_GET['benificiary_ifsc']) && isset($_GET['benificiary_account_no']) )
			{
				...
				if($userinfo->num_rows() == 1)
				{
					...
					if($status == '1')
					{
						...
						if(ctype_digit($sendermobile))
						{
								...
								echo $this->Paytm->add_benificiary($sendermobile,$benificiary_name,$benificiary_mobile,$benificiary_account_no,$benificiary_ifsc,$bank,$userinfo);
						}
						else
						{
							$resp_arr = array(
