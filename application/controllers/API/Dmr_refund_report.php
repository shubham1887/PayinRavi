...
class Dmr_refund_report extends CI_Controller {
...
$this->output->set_header("Pragma: no-cache"); 
		...
		{ 	
			...
			if($this->input->post('btnSearch') == "Search")
			{
				...
				$this->view_data['pagination'] = NULL;
    				    ...
    				    $this->view_data['result_all'] = $this->db->query("SELECT a.refund_date,a.retry,a.API,a.Id,a.order_id,a.add_date,a.edit_date,a.user_id,a.Charge_type,a.charge_value,a.Charge_Amount,a.RemiterMobile,
    ...
    left join tblusers b on a.user_id = b.user_id
     ...
     order by Id desc",array($user_id,$from,$to,$ddlstatus,$ddlstatus,$txtRemitter,$txtRemitter,$txtAccNo,$txtAccNo));    
				...
				$this->load->view('API/dmr_refund_report_view',$this->view_data);		
			}	
...
a.Status = 'FAILURE' and
 Date(a.add_date) >= ? and Date(a.add_date) <= ? and 
 a.user_id = ? order by Id desc limit 50",array($date,$date,$user_id));
