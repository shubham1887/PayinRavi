...
class Dmr_addbene_otpvalidation extends CI_Controller {
	
	public function index()
	{ 
		//http://www.deziremoney.com/appapi/dmr_addbene_otpvalidation?username=&password=&remitter_id=&bene_id=&otp=
				...
				if($userinfo->num_rows() == 1)
				{
					...
					if($status == '1')
					{
						if(ctype_digit($remitter_id))
						{
								...
								echo $this->Instapay->beneficiary_register_validate($remitter_id,$bene_id,$otp,$userinfo);
