...
class VerifyBene_one extends CI_Controller {
							...
							if($status == '1')
							{
								...
								if(ctype_digit($sendermobile))
								{
										...
										$this->load->model("Airtel_model");
											echo $this->Airtel_model->verify_bene_2($sendermobile,$account_number,$ifsc,"",$userinfo);exit;
						...
						if($ip == $client_ip or $ip == $client_ip2 or $ip == $client_ip3 or $ip == $client_ip4)
						{
							if($status == '1')
							{
								...
								if(ctype_digit($sendermobile))
								{
										...
										$this->load->model("Airtel_model");
											echo $this->Airtel_model->verify_bene($sendermobile,$account_number,$ifsc,"",$userinfo);exit;
