...
class Dmr3_account_validation extends CI_Controller {
				...
				if($userinfo->num_rows() == 1)
				{
					...
					if($status == '1')
					{
						...
						if(ctype_digit($remittermobile))
						{
							...
							echo $this->Airtel_model->verify_bene_2($remittermobile,$benificiary_account_no,$benificiary_ifsc,"",$userinfo);exit;
