...
class Filter_bank_ledger_datewise extends CI_Controller {
	...
	public function index()
	{
		if($this->input->post("btnSearch"))
		{
			...
			{
				$rslt_bank_ledger = $this->db->query("SELECT a.creditor_id,a.debtor_id,c.Name,a.Id,a.transaction_date,Sum(a.Withdrawal) as Withdrawal,Sum(a.Deposit) as Deposit,a.Balance,a.Narration,a.Remark,a.expence_id,
				d.Name as DebtorName,
				e.Name as creditor_name,
				exp.Name as exp_name,
				b.Account_Name,
				GROUP_CONCAT(a.Deposit SEPARATOR ' + ') as group_widdep_list 
	...
	",array($txtFromDate,$txtToDate,$ddldebtcrdexp_id));
			...
			else if($debtcrd_type == "CRED")
			{
				...
				exp.Name as exp_name,
				b.Account_Name,
				GROUP_CONCAT(a.Withdrawal SEPARATOR ' + ') as group_widdep_list 
	...
	",array($txtFromDate,$txtToDate));
		    ...
		    $this->view_data["debtcrd_type"] = $debtcrd_type;
			
			$this->view_data["description"] = $txtDescription;
			$this->load->view("Admin/filter_bank_ledger_datewise_view",$this->view_data);	
