...
class Purchase_ledger_datewise extends CI_Controller {
	...
	public function index()
	{
		if($this->input->post("btnSearch"))
		{
			...
			$rslt_bank_ledger = $this->db->query("SELECT a.Id,a.EwId,a.payment_id,a.remark,a.description,a.Ew_add_date,Sum(a.credit_amount) as credit_amount ,Sum(a.debit_amount) as debit_amount,a.balance,a.ew_user_id,a.creditor_id,
	...
	and 
	if(? != 'ALL',a.creditor_id = ?,true) group by Date(a.Ew_add_date)
	order by a.payment_id",array($txtFromDate,$txtToDate,$ddlcreditor,$ddlcreditor));
			...
			$this->load->view("Admin/purchase_ledger_datewise_view",$this->view_data);
	...
	where Date(a.Ew_add_date) = ? group by Date(a.Ew_add_date)
