...
class Groupapi extends CI_Controller {
	...
	{ 
		...
		$this->load->view('SuperDealer/groupapi_view',$this->view_data);		
	}
   ...
   $str.='</table>';
	...
	function ChangeCommission()
	{
		...
		if($groupinfo->num_rows() == 1)
		{
		    ...
		    $md_info = $this->db->query("select scheme_id from tblusers where user_id = ? and usertype_name = 'SuperDealer'",array($user_id));
