...
class Distributor_list extends CI_Controller {
	...
	public function pageview()
	{
		...
		$config['base_url'] = base_url()."_Admin/distributor_list/pageview";
		...
		$this->load->view('_Admin/distributor_list_view',$this->view_data);		
	}
			...
			{							
				...
				if($userinfo->num_rows() == 1)
				{
					if($userinfo->row(0)->status == 0)
					{
						...
						redirect(base_url()."_Admin/distributor_list");
					}
