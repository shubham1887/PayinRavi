		...
		{ 
			...
			{		
			   // print_r($this->input->post());exit;
				...
				$downline_scheme = $this->input->post("ddlDownSchDesc");
				$txtIdLimit = intval(trim($this->input->post("txtIdLimit")));				
				$this->db->query("update tblusers set id_limit = ? where user_id = ?",array($txtIdLimit,$User_id));
				...
				$access_rights = $this->Service_model->getAccessRights("Distributor");
