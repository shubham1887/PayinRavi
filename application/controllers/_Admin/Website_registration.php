...
class Website_registration extends CI_Controller {
...
$this->output->set_header("Pragma: no-cache"); 
		...
		if($this->input->post("btnSubmit"))
		{
				...
				{	
						...
						{ 
							...
							if($status == "0")
							{
								...
								redirect("_Admin/Website_registration");
							}
							else
							{
				...
				{	
					...
					$this->load->view('_Admin/website_registration_view',$data);
				}
