...
class GetRechargeValues extends CI_Controller {
	...
	{
		return $this->session->userdata("AgentUserName")."#".$this->session->userdata("AgentBusinessName")."#0#".$this->Common_methods->getAgentBalance2($this->session->userdata("AgentId"));
	}
