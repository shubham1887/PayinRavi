...
class PayinUser extends CI_Controller {
	...
	public function pageview()
	{
		...
		$config['base_url'] = base_url()."_Admin/PayinUser/pageview";
		$config['total_rows'] = $total_row;
		$config['per_page'] = $per_page; 
		$this->pagination->initialize($config); 
		$this->view_data['pagination'] = $this->pagination->create_links();
		$this->view_data['result_dealer'] = $this->db->query("
	select a.user_id , a.ParentID , a.UniqueCode , a.NextNo , a.Username , a.Password , a.TPin , a.Usertype, a.AddDate, a.EditDate, a.Status, a.FirstName , a.MiddleName, a.LastName , a.MobileNo , a.EmailId, a.SchemeId , a.FirmName , a.IP , a.KYCStatus , a.CapAmt , a.Balance , a.WhiteLabelID , a.DeviceId , a.IsBlock , a.AEPSLimit , a.AEPSBalance , a.Column_29 from payin_userid a where a.Usertype = 'FRC'
		...
		$this->load->view('_Admin/PayinUser_view',$this->view_data);		
	}
...
$this->output->set_header("Pragma: no-cache"); 
			...
			{							
				...
				if($userinfo->num_rows() == 1)
				{
					if($userinfo->row(0)->status == 0)
					{
						...
						redirect(base_url()."_Admin/PayinUser");
					}
			...
			else if($this->input->post("action") == "delete")
			{
			    ...
			    if($userinfo->num_rows() == 1)
			    {
			      ...
			      if($w1 != 0)
			      {
		            ...
		            redirect(base_url()."_Admin/PayinUser?crypt=".$this->Common_methods->encrypt("MyData"));
			      }
			      else if($w2 != 0)
			      {
			        $this->session->set_flashdata("MESSAGEBOX_MESSAGETYPE","FAILURE");
	...
	public function Search($SearchBy,$SearchWord)
	{
		...
		select a.user_id , a.ParentID , a.UniqueCode , a.NextNo , a.Username , a.Password , a.TPin , a.Usertype, a.AddDate, a.EditDate, a.Status, a.FirstName , a.MiddleName, a.LastName , a.MobileNo , a.EmailId, a.SchemeId , a.FirmName , a.IP , a.KYCStatus , a.CapAmt , a.Balance , a.WhiteLabelID , a.DeviceId , a.IsBlock , a.AEPSLimit , a.AEPSBalance , a.Column_29 from payin_userid a where a.Usertype = 'FRC' and
  ...
  from payin_userid a 
		...
		left join payin_userid p on a.ParentID = p.ID
		where
  ...
  from payin_userid a 
	...
	public function getbalance()
	{
		...
		$id = $_GET["id"];
	   echo $id."#".round($this->Common_methods->getAgentBalancePayin($id),2);exit;
