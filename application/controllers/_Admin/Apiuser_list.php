...
class Apiuser_list extends CI_Controller {
	...
	public function pageview()
	{
		...
		$config['base_url'] = base_url()."_Admin/apiuser_list/pageview";
		...
		$this->load->view('_Admin/apiuser_list_view',$this->view_data);		
	}
...
$this->output->set_header("Pragma: no-cache"); 
	...
	//	print_r($result->result());exit;
		...
		{
			redirect(base_url()."_Admin/apiuser_list?crypt=".$this->Common_methods->encrypt("MyData"));
		}				
	}
