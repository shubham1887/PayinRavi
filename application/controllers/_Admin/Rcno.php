<?php
class Rcno extends  CI_Controller 
{   
    function _construct()
    {
    ...
    public function index()
    {
        ...
        if($this->input->post("btnSubmit"))
        {
            ...
            {
                $opening_balance_rslt = $this->db->query("select balance from tblewallet where user_id = ? and Date(add_date) < ? order by Id desc limit 1",array($rwuser->user_id,$from));
            ...
            {
                $clossing_balance_rslt = $this->db->query("select balance from tblewallet where user_id = ? and Date(add_date) <= ? order by Id desc limit 1",array($rwuser_clossing->user_id,$from));
        ...
        b.businessname,b.username,b.usertype_name,b.user_id FROM `tblewallet` a 
    ...
    a.usertype_name != 'Admin'");
        ...
        else
        {
            ...
            $this->load->view("_Admin/rcno_view",$this->view_data);
        }
