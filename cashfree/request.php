...
extract($_POST);
  $secretKey = "aa0bf2ebc20d5d82b9429efc6cbb39617d957af6";
  $postData = array( 
  "appId" =>"152685674391dbe456e2241175586251", 
  "orderId" => $orderId, 
...
?>
  <form action="<?php echo $url; ?>" name="frm1" method="post">
      ...
      <input type="hidden" name="appId" value='<?php echo "152685674391dbe456e2241175586251"; ?>'/>
